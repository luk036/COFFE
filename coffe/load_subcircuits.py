def general_routing_load_generate(
    spice_filename,
    wire_length,
    tile_sb_on,
    tile_sb_partial,
    ...
    for i in range(wire_length):
        ...
        if i == 0:
            spice_file.write(
                ".SUBCKT routing_wire_load_tile_"
                + str(i + 1)
                + " n_in n_out n_cb_out n_gate n_gate_n n_vdd n_gnd n_vdd_sb_mux_on n_vdd_cb_mux_on\n"
            )
        else:
            spice_file.write(
                ".SUBCKT routing_wire_load_tile_"
                + str(i + 1)
                + " n_in n_out n_cb_out n_gate n_gate_n n_vdd n_gnd\n"
            )
        spice_file.write(
            "Xwire_gen_routing_1 n_in n_1_1 wire Rw='wire_gen_routing_res/"
            + str(2 * wire_length)
            + "' Cw='wire_gen_routing_cap/"
            + str(2 * wire_length)
            + "'\n\n"
        )
            ...
            if i == 0:
                if sb_on != 0:
                    spice_file.write(
                        ...
                        + " n_1_1 n_1_sb_on_"
                        + str(sb_on + 1)
                        + " wire Rw=wire_sb_load_on_res Cw=wire_sb_load_on_cap\n"
                    )
                    spice_file.write(
                        "Xsb_load_on_"
                        + str(sb_on + 1)
                        ...
                        + " n_sb_mux_on_"
                        + str(sb_on + 1)
                        + "_hang n_gate n_gate_n n_vdd n_gnd sb_mux_on\n\n"
                    )
            else:
                spice_file.write(
                    "Xwire_sb_load_on_"
        ...
        for sb_partial in range(tile_sb_partial[i]):
            spice_file.write(
                "Xwire_sb_load_partial_"
                + str(sb_partial + 1)
                + " n_1_1 n_1_sb_partial_"
                + str(sb_partial + 1)
                + " wire Rw=wire_sb_load_partial_res Cw=wire_sb_load_partial_cap\n"
            )
            spice_file.write(
                "Xsb_load_partial_"
                + str(sb_partial + 1)
                + " n_1_sb_partial_"
                + str(sb_partial + 1)
                + " n_gate n_gate_n n_vdd n_gnd sb_mux_partial\n\n"
            )
        ...
        for sb_off in range(tile_sb_off[i]):
            spice_file.write(
                ...
                + " n_1_1 n_1_sb_off_"
                + str(sb_off + 1)
                + " wire Rw=wire_sb_load_off_res Cw=wire_sb_load_off_cap\n"
            )
            spice_file.write(
                "Xsb_load_off_"
                + str(sb_off + 1)
                + " n_1_sb_off_"
                + str(sb_off + 1)
                + " n_gate n_gate_n n_vdd n_gnd sb_mux_off\n\n"
            )
            ...
            if i == 0:
                ...
                if cb_on == 0:
                    spice_file.write(
                        ...
                        + " n_1_1 n_1_cb_on_"
                        + str(cb_on + 1)
                        + " wire Rw=wire_cb_load_on_res Cw=wire_cb_load_on_cap\n"
                    )
                    spice_file.write(
                        "Xcb_load_on_"
                        + str(cb_on + 1)
                        + " n_1_cb_on_"
                        + str(cb_on + 1)
                        + " n_cb_out n_gate n_gate_n n_vdd_cb_mux_on n_gnd cb_mux_on\n\n"
                    )
            else:
                spice_file.write(
                    "Xwire_cb_load_on_"
                ...
                spice_file.write(
                    ...
                    + " n_cb_mux_on_"
                    + str(cb_on + 1)
                    + "_hang n_gate n_gate_n n_vdd n_gnd cb_mux_on\n\n"
                )
        # Write partially on connection block loads
        for cb_partial in range(tile_cb_partial[i]):
            spice_file.write(
                "Xwire_cb_load_partial_"
                + str(cb_partial + 1)
                + " n_1_1 n_1_cb_partial_"
                + str(cb_partial + 1)
                + " wire Rw=wire_cb_load_partial_res Cw=wire_cb_load_partial_cap\n"
            )
            spice_file.write(
                "Xcb_load_partial_"
                + str(cb_partial + 1)
                + " n_1_cb_partial_"
                + str(cb_partial + 1)
                + " n_gate n_gate_n n_vdd n_gnd cb_mux_partial\n\n"
            )
        ...
        for cb_off in range(tile_cb_off[i]):
            spice_file.write(
                ...
                + " n_1_1 n_1_cb_off_"
                + str(cb_off + 1)
                + " wire Rw=wire_cb_load_off_res Cw=wire_cb_load_off_cap\n"
            )
            spice_file.write(
                "Xcb_load_off_"
                + str(cb_off + 1)
                + " n_1_cb_off_"
                + str(cb_off + 1)
                + " n_gate n_gate_n n_vdd n_gnd cb_mux_off\n\n"
            )
        ...
        if i == 0:
            spice_file.write(
                "Xwire_gen_routing_2 n_1_1 n_1_2 wire Rw='wire_gen_routing_res/"
                + str(2 * wire_length)
                + "' Cw='wire_gen_routing_cap/"
                + str(2 * wire_length)
                + "'\n"
            ...
            spice_file.write(
                "Xwire_gen_routing_2 n_1_1 n_out wire Rw='wire_gen_routing_res/"
                + str(2 * wire_length)
                + "' Cw='wire_gen_routing_cap/"
                + str(2 * wire_length)
                + "'\n"
    ...
    for tile in range(wire_length, 1, -1):
        ...
        spice_file.write(
            ...
            + " n_hang_"
            + str(tile)
            + " n_gate n_gate_n n_vdd n_gnd routing_wire_load_tile_"
            + str(tile)
            + "\n"
        )
        in_node = out_node
    # Write tile 1
    spice_file.write(
        "Xrouting_wire_load_tile_1 "
        + in_node
        + " n_out n_cb_out n_gate n_gate_n n_vdd n_gnd n_vdd_sb_mux_on n_vdd_cb_mux_on routing_wire_load_tile_1\n"
    )
    spice_file.write(".ENDS\n\n\n")
    ...
    for i in range(int(num_total)):
        if interval_counter_partial == interval_partial and on_counter < num_on:
            ...
            if on_counter == num_on:
                spice_file.write(
                    "Xwire_local_routing_"
                    + str(i + 1)
                    + " "
                    + current_node
                    + " "
                    + next_node
                    + " wire Rw='wire_local_routing_res/"
                    + str(num_total)
                    + "' Cw='wire_local_routing_cap/"
                    + str(num_total)
                    + "'\n"
                )
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_out n_gate n_gate_n n_vdd_local_mux_on n_gnd local_mux_on\n"
                )
            else:
                spice_file.write(
                    "Xwire_local_routing_"
                ...
                spice_file.write(
                    ...
                    + " n_hang_"
                    + str(on_counter)
                    + " n_gate n_gate_n n_vdd n_gnd local_mux_on\n"
                )
        else:
            if interval_counter_off == interval_off and partial_counter < num_partial:
                ...
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_gate n_gate_n n_vdd n_gnd local_mux_partial\n"
                )
            else:
                # Add an off mux
                ...
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_gate n_gate_n n_vdd n_gnd local_mux_off\n"
                )
...
def hb_local_routing_load_generate(
    spice_filename, num_on, num_partial, num_off, hb_name, mux_name
):
    """ """
    ...
    spice_file.write(
        ".SUBCKT "
        + hb_name
        + " n_in n_out n_gate n_gate_n n_vdd n_gnd n_vdd_local_mux_on\n"
    )
        ...
        if interval_counter_partial == interval_partial and on_counter < num_on:
            ...
            if on_counter == num_on:
                ...
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_out n_gate n_gate_n n_vdd_local_mux_on n_gnd "
                    + mux_name
                    + "_on\n"
                )
            else:
...
def RAM_local_routing_load_generate(spice_filename, num_on, num_partial, num_off):
    ...
    for i in range(num_total):
        if interval_counter_partial == interval_partial and on_counter < num_on:
            ...
            if on_counter == num_on:
                spice_file.write(
                    "Xwire_RAM_local_routing_"
                    + str(i + 1)
                    + " "
                    + current_node
                    + " "
                    + next_node
                    + " wire Rw='wire_RAM_local_routing_res/"
                    + str(num_total)
                    + "' Cw='wire_RAM_local_routing_cap/"
                    + str(num_total)
                    + "'\n"
                )
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_out n_gate n_gate_n n_vdd_RAM_local_mux_on n_gnd RAM_local_mux_on\n"
                )
            else:
                spice_file.write(
                    "Xwire_RAM_local_routing_"
                ...
                spice_file.write(
                    ...
                    + " n_hang_"
                    + str(on_counter)
                    + " n_gate n_gate_n n_vdd n_gnd RAM_local_mux_on\n"
                )
        else:
            if interval_counter_off == interval_off and partial_counter < num_partial:
                # Add a partially on mux
                ...
                spice_file.write(
                    "XRAM_local_mux_partial_"
                    + str(partial_counter)
                    + " "
                    + next_node
                    + " n_gate n_gate_n n_vdd n_gnd RAM_local_mux_partial\n"
                )
            else:
                # Add an off mux
                interval_counter_off = interval_counter_off + 1
                ...
                spice_file.write(
                    ...
                    + " "
                    + next_node
                    + " n_gate n_gate_n n_vdd n_gnd RAM_local_mux_off\n"
                )
        # Update current and next nodes
        current_node = next_node
        next_node = "n_" + str(i + 2)
...
def generate_ble_outputs(spice_filename, num_local_out, num_gen_out):
    ...
    spice_file.write(
        ".SUBCKT ble_outputs n_1_"
        + str((total_outputs + 1) / 2 + 1)
        + " n_local_out n_general_out n_gate n_gate_n n_vdd n_gnd n_vdd_local_output_on n_vdd_general_output_on\n"
    )
    ...
    for i in range(num_local_out):
        ...
        if i == 0:
            spice_file.write(
                ...
                + " n_1_"
                + str(current_node)
                + " n_local_out n_gate n_gate_n n_vdd_local_output_on n_gnd local_ble_output\n"
            )
        else:
            spice_file.write(
                "Xlocal_ble_output_"
                ...
                + " n_hang_"
                + str(current_node)
                + " n_gate n_gate_n n_vdd n_gnd local_ble_output\n"
            )
        spice_file.write(
            "Xwire_ble_outputs_"
            + str(i + 1)
            ...
            + " n_1_"
            + str(current_node + 1)
            + " wire Rw='wire_ble_outputs_res/"
            + str(total_outputs - 1)
            + "' Cw='wire_ble_outputs_cap/"
            + str(total_outputs - 1)
            + "'\n"
        )
    ...
    for i in range(num_gen_out):
        ...
        if i == 0:
            spice_file.write(
                "Xgeneral_ble_output_"
                + str(i + 1)
                + " n_1_"
                + str(current_node)
                + " n_general_out n_gate n_gate_n n_vdd_general_output_on n_gnd general_ble_output\n"
            )
        else:
            spice_file.write(
                "Xgeneral_ble_output_"
                ...
                + " n_hang_"
                + str(current_node)
                + " n_gate n_gate_n n_vdd n_gnd general_ble_output\n"
            )
        # Only add wire if this is not the last ble output.
        if (i + 1) != num_gen_out:
            spice_file.write(
                "Xwire_ble_outputs_"
                + str(num_local_out + i + 1)
                + " n_1_"
                + str(current_node)
                + " n_1_"
                + str(current_node + 1)
...
def generate_general_ble_output_load(
    spice_filename, num_sb_mux_off, num_sb_mux_partial, num_sb_mux_on
):
    ...
    for i in range(num_sb_mux_off):
        spice_file.write(
            "Xwire_general_ble_output_"
            + str(i + 1)
            + " "
            + current_node
            + " "
            + next_node
            + " wire Rw='wire_general_ble_output_res/"
            + str(sb_mux_total)
            + "' Cw='wire_general_ble_output_cap/"
            + str(sb_mux_total)
            + "'\n"
        )
        spice_file.write(
    ...
    for i in range(num_sb_mux_on):
        ...
        if i == (num_sb_mux_on - 1):
            spice_file.write(
                "Xwire_general_ble_output_"
                + str(i + num_sb_mux_off + num_sb_mux_partial + 1)
                + " "
                + current_node
                + " n_meas_point"
                + " wire Rw='wire_general_ble_output_res/"
            ...
            spice_file.write(
                "Xsb_mux_on_"
                + str(i + 1)
                + " n_meas_point n_out n_gate n_gate_n n_vdd n_gnd sb_mux_on\n"
            )
        else:
            spice_file.write(
                "Xwire_general_ble_output_"
            ...
            spice_file.write(
                ...
                + " n_hang_"
                + str(i)
                + " n_gate n_gate_n n_vdd n_gnd sb_mux_on\n"
            )
        current_node = next_node
