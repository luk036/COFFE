...
def generate_sram_read_power_top(name, sram_per_column, unselected_column_count):
    ...
    the_file.write(
        "Vprecharge n_precharge gnd PULSE (supply_v 0 0 50p 50p 'precharge_max' 'ram_frequency')\n")
    the_file.write(
        "Vprecharge2 n_precharge2 gnd PULSE (supply_v 0 0 50p 50p 'precharge_max' 'ram_frequency')\n")
    the_file.write(
        "Vwl n_wl_eva gnd PULSE (supply_v 0 0 50p 50p 'wl_eva' 'ram_frequency')\n")
    ...
    the_file.write(
        ".MEASURE TRAN meas_avg_power_selected PARAM = '-(meas_current_selected/(4 * ram_frequency)) * supply_v'\n\n")
    the_file.write(
        ".MEASURE TRAN meas_current_unselected INTEGRAL I(V_unselected) FROM=0ns TO='4 * ram_frequency'\n")
    the_file.write(
        ".MEASURE TRAN meas_avg_power_unselected PARAM = '-(meas_current_unselected/(4 * ram_frequency)) * supply_v'\n\n")
    ...
    # column selectors
    the_file.write(
        "xtgate1 n_bl_0 tgate_l vdd gnd vdd_selected gnd RAM_tgate\n")
    the_file.write(
        "xtgater n_br_0 tgate_r vdd gnd vdd_selected gnd RAM_tgate\n")
    the_file.write(
        "xprecharge n_precharge n_bl_0 n_br_0 vdd_selected gnd precharge\n")
    if duplicate == 1:
        the_file.write(
            "xprecharge_dup n_precharge n_bl_512 n_br_512 vdd_selected gnd precharge\n")

    # unselected columns
    for i in range(0, unselected_column_count):
        the_file.write("xtgatel_"+str(i)+" n_bl"+str(i) +
                       "_0 tgate_l gnd vdd vdd_unselected gnd RAM_tgate\n")
        the_file.write("xtgater_"+str(i)+" n_br"+str(i) +
                       "_0 tgate_r gnd vdd vdd_unselected gnd RAM_tgate\n")
        the_file.write("xprecharge"+str(i)+" n_precharge n_bl" +
                       str(i)+"_0 n_br"+str(i)+"_0 vdd_unselected gnd precharge\n")
        if duplicate == 1:
            the_file.write("xprecharge"+str(i)+"_dup n_precharge n_bl" +
                           str(i)+"_512 n_br"+str(i)+"_512 vdd_unselected gnd precharge\n")
    # SRAM cells
    # selected column:
    for i in range(0, sram_per_column - 1):
        the_file.write("Xwirel"+str(i)+" n_bl_"+str(i)+" n_bl_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
        the_file.write("Xwirer"+str(i)+" n_br_"+str(i)+" n_br_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
        the_file.write("Xsram"+str(i)+" gnd gnd n_bl_"+str(i + 1) +
                       " gnd n_br_"+str(i + 1)+" gnd vdd_selected gnd memorycell\n")
    the_file.write("Xwirel"+str(sram_per_column - 1)+" n_bl_"+str(sram_per_column - 1)+" n_bl_"+str(sram_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
    the_file.write("Xwirer"+str(sram_per_column - 1)+" n_br_"+str(sram_per_column - 1)+" n_br_"+str(sram_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
    the_file.write("Xsram"+str(sram_per_column - 1)+" n_precharge2 gnd n_bl_"+str(
        sram_per_column)+" gnd n_br_"+str(sram_per_column)+" gnd vdd_selected gnd memorycell\n")
    # unselected column:
    for j in range(0, unselected_column_count):
        for i in range(0, sram_per_column - 1):
            the_file.write("Xwire"+str(j)+"l"+str(i)+" n_bl"+str(j)+"_"+str(i)+" n_bl"+str(j)+"_"+str(i+1) +
                           " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
            the_file.write("Xwire"+str(j)+"r"+str(i)+" n_br"+str(j)+"_"+str(i)+" n_br"+str(j)+"_"+str(i+1) +
                           " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
            the_file.write("Xsram_"+str(j)+"_"+str(i)+" gnd gnd n_bl"+str(j)+"_"+str(
                i + 1)+" gnd n_br"+str(j)+"_"+str(i + 1)+" gnd vdd_unselected gnd memorycell\n")
        the_file.write("Xwire"+str(j)+"l"+str(sram_per_column - 1)+" n_bl"+str(j)+"_"+str(sram_per_column - 1)+" n_bl"+str(j)+"_"+str(sram_per_column) +
                       " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
        the_file.write("Xwire"+str(j)+"r"+str(sram_per_column - 1)+" n_br"+str(j)+"_"+str(sram_per_column - 1)+" n_br"+str(j)+"_"+str(sram_per_column) +
                       " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
        the_file.write("Xsram_"+str(j)+"_"+str(sram_per_column - 1)+" n_precharge2 gnd n_bl"+str(j)+"_"+str(
            sram_per_column)+" gnd n_br"+str(j)+"_"+str(sram_per_column)+" gnd vdd_unselected gnd memorycell\n")
    # initial conditions:
    ...
    for i in range(0, sram_per_column):
        for j in range(0, unselected_column_count):
            ...
            the_file.write(".IC V(Xsram_"+str(j)+"_" +
                           str(i)+".n_1_1) = 'supply_v' \n")
...
def generate_sram_writelh_power_top_lp(name, sram_per_column, unselected_column_count):
    ...
    for i in range(0, unselected_column_count):
        the_file.write("xtgatel_"+str(i)+" n_bl"+str(i) +
                       "_0 tgate_l gnd vdd_lp vdd_unselected gnd RAM_tgate\n")
        the_file.write("xtgater_"+str(i)+" n_br"+str(i) +
                       "_0 tgate_r gnd vdd_lp vdd_unselected gnd RAM_tgate\n")
        the_file.write("xprecharge"+str(i)+" n_precharge n_bl" +
                       str(i)+"_0 n_br"+str(i)+"_0 vdd_unselected gnd precharge\n")
        if duplicate == 1:
            the_file.write("xprecharge"+str(i)+"_dup n_precharge n_bl" +
    ...
    the_file.write("Xwirer"+str(sram_per_column - 1)+" n_br_"+str(sram_per_column - 1)+" n_br_"+str(sram_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
    the_file.write("Xsram"+str(sram_per_column - 1)+" n_precharge gnd n_bl_"+str(
        sram_per_column)+" gnd n_br_"+str(sram_per_column)+" gnd vdd_selected gnd memorycell\n")
    # unselected column:
    for j in range(0, unselected_column_count):
        for i in range(0, sram_per_column - 1):
        ...
        the_file.write("Xwire"+str(j)+"r"+str(sram_per_column - 1)+" n_br"+str(j)+"_"+str(sram_per_column - 1)+" n_br"+str(j)+"_"+str(sram_per_column) +
                       " wire Rw=wire_memorycell_vertical_res/"+str(sram_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(sram_per_column)+"\n")
        the_file.write("Xsram_"+str(j)+"_"+str(sram_per_column - 1)+" n_precharge gnd n_bl"+str(j)+"_"+str(
            sram_per_column)+" gnd n_br"+str(j)+"_"+str(sram_per_column)+" gnd vdd_unselected gnd memorycell\n")
    # initial conditions:
    # one of the bitline is set to vdd, the other set to 0:
    ...
    for i in range(0, sram_per_column):
        for j in range(0, unselected_column_count):
            the_file.write(
                ".IC V(n_bl"+str(j)+"_"+str(i)+") = 'supply_v_lp' \n")
            the_file.write(".IC V(n_br"+str(j)+"_"+str(i)+") = 0 \n")
            the_file.write(".IC V(Xsram_"+str(j)+"_"+str(i) +
                           ".n_1_1) = 'supply_v_lp' \n")
            the_file.write(".IC V(Xsram_"+str(j)+"_"+str(i)+".n_1_2) = 0 \n")

    the_file.write(".print tran V(tgate_l) V(tgate_r) V(n_bl_0) V(n_bl_"+str(sram_per_column)+") V(n_br_0) V(Xprechargesa.n_1_2) V(n_br_"+str(sram_per_column)+") V(n_bl"+str(0)+"_"+str(sram_per_column) +
                   ") V(n_br"+str(0)+"_"+str(sram_per_column)+") V(Xsram"+str(sram_per_column - 1)+".n_1_2) V(Xsram"+str(sram_per_column - 1)+".n_1_1) V(n_precharge) V(n_wl_eva) I(V_unselected) I(V_selected)\n")
    the_file.write(".END")
    the_file.close()
...
def generate_mtj_read_power_top_lp(name, mtj_per_column):
    ...
    the_file.write(
        "Vprecharge n_precharge gnd PULSE (supply_v_lp 0 0 50p 50p 'precharge_max' 'ram_frequency')\n")
    the_file.write(
        "Vprechargeb n_precharge_b gnd PULSE (0 supply_v_lp 0 50p 50p 'precharge_max' 'ram_frequency')\n")
    the_file.write(
        "Vse1 n_se1 gnd PULSE (supply_v_lp 0 0 50p 50p 'sa_se1' 'ram_frequency')\n")
    the_file.write(
        "Vse2 n_se2 gnd PULSE (supply_v_lp 0 0 50p 50p 'sa_se2' 'ram_frequency')\n")
    ...
    the_file.write(
        ".MEASURE TRAN meas_current_readl INTEGRAL I(V_readl) FROM= 0ns TO='4 * ram_frequency'\n")
    the_file.write(
        ".MEASURE TRAN meas_avg_power_readl PARAM = '-(meas_current_readl/(4 * ram_frequency)) * supply_v_lp'\n\n")

    the_file.write(
        ".MEASURE TRAN meas_current_readh INTEGRAL I(V_readh) FROM= 0ns TO='4 * ram_frequency'\n")
    the_file.write(
        ".MEASURE TRAN meas_avg_power_readh PARAM = '-(meas_current_readh/(4 * ram_frequency)) * supply_v_lp'\n\n")
    ...
    the_file.write(
        "Xprechargesa n_1_1 n_2_1 n_se1 n_se2 n_hang_out vclmpmtj vrefmtj gnd vdd_lp vdd_readl gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "Xwritedriver gnd gnd n_1_1 gnd vdd_readl gnd mtj_subcircuits_writedriver\n")
    the_file.write(
        "Xwritedriver_ref gnd gnd n_2_1 gnd vdd_readl gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "Xcs n_1_1 n_bl_0 n_precharge_b n_precharge vdd_readl gnd mtj_subcircuits_cs\n")
    the_file.write(
        "Xcs_ref n_2_1 n_bl2_0 n_precharge_b n_precharge vdd_readl gnd mtj_subcircuits_cs\n")
    if duplicate == 1:
        the_file.write(
            "xprecharge_dup n_hang_low n_bl_512 n_precharge_b n_precharge vdd_readl gnd mtj_subcircuits_cs\n")
        the_file.write(
            "xprecharge_dup_ref n_hang2_low n_bl2_512 n_precharge_b n_precharge vdd_readl gnd mtj_subcircuits_cs\n")

    # MTJ cells
    # Selected column:
    for i in range(0, mtj_per_column - 1):
        the_file.write("Xwirel"+str(i)+" n_bl_"+str(i)+" n_bl_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("Xwirer"+str(i)+" n_br_"+str(i)+" n_br_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("Xmtj"+str(i)+" gnd gnd n_bl_"+str(i + 1) +
                       " gnd n_br_"+str(i + 1)+" gnd vdd_readl gnd memorycell\n")
    the_file.write("Xwirel"+str(mtj_per_column - 1)+" n_bl_"+str(mtj_per_column - 1)+" n_bl_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("Xwirer"+str(mtj_per_column - 1)+" n_br_"+str(mtj_per_column - 1)+" n_br_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("Xmtj"+str(mtj_per_column - 1)+" n_precharge gnd n_bl_"+str(
        mtj_per_column)+" gnd n_br_"+str(mtj_per_column)+" gnd vdd_readl gnd memorycell\n")

    # Reference bank:
    for i in range(1, mtj_per_column):
        the_file.write("Xwirel"+str(i)+"_ref n_bl2_"+str(i)+" n_bl2_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("Xwirer"+str(i)+"_ref n_br2_"+str(i)+" n_br2_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("Xmtj"+str(i)+"_ref gnd gnd n_bl2_"+str(i + 1) +
                       " gnd n_br2_"+str(i + 1)+" gnd vdd_readl gnd memorycell\n")
    the_file.write("Xwirel"+str(0)+"_ref n_bl2_"+str(0)+" n_bl2_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("Xwirer"+str(0)+"_ref n_br2_"+str(0)+" n_br2_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("Xmtj"+str(0)+"_ref n_precharge gnd n_bl2_" +
                   str(1)+" gnd n_br2_"+str(1)+" gnd vdd_readl gnd memorycell\n")
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "X2prechargesa n2_1_1 n2_2_1 n_se1 n_se2 n2_hang_out vclmpmtj vrefmtj gnd vdd_lp vdd_readh gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "X2writedriver gnd gnd n2_1_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    the_file.write(
        "X2writedriver_ref gnd gnd n2_2_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "X2cs n2_1_1 n2_bl_0 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    the_file.write(
        "X2cs_ref n2_2_1 n2_bl2_0 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    if duplicate == 1:
        the_file.write(
            "x2precharge_dup n2_hang_low n2_bl_512 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")
        the_file.write(
            "x2precharge_dup_ref n2_hang2_low n2_bl2_512 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")

    # MTJ cells
    # Selected column:
    for i in range(0, mtj_per_column - 1):
        the_file.write("X2wirel"+str(i)+" n2_bl_"+str(i)+" n2_bl_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("X2wirer"+str(i)+" n2_br_"+str(i)+" n2_br_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("X2mtj"+str(i)+" gnd gnd n2_bl_"+str(i + 1) +
                       " gnd n2_br_"+str(i + 1)+" gnd vdd_readh gnd memorycellh\n")
    the_file.write("X2wirel"+str(mtj_per_column - 1)+" n2_bl_"+str(mtj_per_column - 1)+" n2_bl_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2wirer"+str(mtj_per_column - 1)+" n2_br_"+str(mtj_per_column - 1)+" n2_br_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2mtj"+str(mtj_per_column - 1)+" n_precharge gnd n2_bl_"+str(
        mtj_per_column)+" gnd n2_br_"+str(mtj_per_column)+" gnd vdd_readh gnd memorycellh\n")

    # Reference bank:
    for i in range(1, mtj_per_column):
        the_file.write("X2wirel"+str(i)+"_ref n2_bl2_"+str(i)+" n2_bl2_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("X2wirer"+str(i)+"_ref n2_br2_"+str(i)+" n2_br2_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("X2mtj"+str(i)+"_ref gnd gnd n2_bl2_"+str(i + 1) +
                       " gnd n2_br2_"+str(i + 1)+" gnd vdd_readh gnd memorycellh\n")
    the_file.write("X2wirel"+str(0)+"_ref n2_bl2_"+str(0)+" n2_bl2_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2wirer"+str(0)+"_ref n2_br2_"+str(0)+" n2_br2_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2mtj"+str(0)+"_ref n_precharge gnd n2_bl2_" +
                   str(1)+" gnd n2_br2_"+str(1)+" gnd vdd_readh gnd memorycell\n")
...
def generate_mtj_write_power_top_lp(name, mtj_per_column):
    ...
    the_file.write(
        ".MEASURE TRAN meas_current_selectedn INTEGRAL I(V_negl) FROM= 0ns TO='4 * ram_frequency'\n")
    the_file.write(
        ".MEASURE TRAN meas_avg_power_selectedn PARAM = '-(meas_current_selectedn/(4 * ram_frequency)) * 0.27'\n\n")

    the_file.write(
        ".MEASURE TRAN meas_current_selectedh INTEGRAL I(V_selectedh) FROM= 0ns TO='4 * ram_frequency'\n")
    the_file.write(
        ".MEASURE TRAN meas_avg_power_selectedh PARAM = '-(meas_current_selectedh/(4 * ram_frequency)) * supply_v_lp'\n\n")

    the_file.write(
        ".MEASURE TRAN meas_current_selectedhn INTEGRAL I(V_negh) FROM= 0ns TO='4 * ram_frequency'\n")
    the_file.write(
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "Xprechargesa n_1_1 n_hang_1 gnd gnd n_hang_out vclmpmtj vrefmtj gnd gnd vdd_lp gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "Xwritedriver n_data_in vdd_lp n_1_1 vnegl vdd_selected gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "Xcs n_1_1 n_bl_0 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    if duplicate == 1:
        the_file.write(
            "xprecharge_dup n_hang_low n_bl_512 n_precharge_b n_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    ...
    the_file.write("Xwirer"+str(mtj_per_column - 1)+" n_br_"+str(mtj_per_column - 1)+" n_br_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("Xmtj"+str(mtj_per_column - 1)+" n_precharge gnd n_bl_"+str(mtj_per_column) +
                   " gnd n_br_"+str(mtj_per_column)+" gnd vdd_selected gnd memorycell\n")
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "X2prechargesa n2_1_1 n2_hang_1 gnd gnd n2_hang_out vclmpmtj vrefmtj gnd gnd vdd_lp gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "X2writedriver n2_data_in vdd_lp n2_1_1 vnegh vdd_selectedh gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "X2cs n2_1_1 n2_bl_0 n2_precharge_b n2_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    if duplicate == 1:
        the_file.write(
            "x2precharge_dup n2_hang_low n2_bl_512 n2_precharge_b n2_precharge vdd_lp gnd mtj_subcircuits_cs\n")
    ...
    for i in range(0, mtj_per_column - 1):
        ...
        the_file.write("X2wirer"+str(i)+" n2_br_"+str(i)+" n2_br_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
        the_file.write("X2mtj"+str(i)+" gnd gnd n2_bl_"+str(i + 1) +
                       " gnd n2_br_"+str(i + 1)+" gnd vdd_selectedh gnd memorycellh\n")
    the_file.write("X2wirel"+str(mtj_per_column - 1)+" n2_bl_"+str(mtj_per_column - 1)+" n2_bl_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2wirer"+str(mtj_per_column - 1)+" n2_br_"+str(mtj_per_column - 1)+" n2_br_"+str(mtj_per_column) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(mtj_per_column)+" Cw=wire_memorycell_vertical_cap/"+str(mtj_per_column)+"\n")
    the_file.write("X2mtj"+str(mtj_per_column - 1)+" n_precharge gnd n2_bl_"+str(mtj_per_column) +
                   " gnd n2_br_"+str(mtj_per_column)+" gnd vdd_selectedh gnd memorycellh\n")
...
def generate_pgateoutputcrossbar_top(name, maxwidth, def_use_tgate):
    ...
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    the_file.write(
        "+    TARG V(xoutputcrossbar.n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        "+    TARG V(xoutputcrossbar.n_1_1) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* inv_" + name + " delay\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_tfall TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        "+    TARG V(xoutputcrossbar.n_1_2) VAL='supply_v/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_trise TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    the_file.write(
    ...
    if def_use_tgate == 0:
        ...
        the_file.write("* inv_" + name + " delay\n")
        the_file.write(".MEASURE TRAN meas_inv_" + name +
                       "_3_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
        the_file.write(
            "+    TARG V(xoutputcrossbar.n_1_3) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meas_inv_" + name +
                       "_3_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write(
...
def generate_configurabledecoderiii_top(name, fanin1, fanin2, required_size, tgatecount):
    ...
    if fanin1 != 0:
        the_file.write("* inv_nand" + str(required_size) +
                       "" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand" + str(required_size) + "_" +
                       name + "_1_tfall TRIG V(n_1_"+str(fanin1)+") VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand" + str(required_size) + "_" +
                       name + "_1_trise TRIG V(n_1_"+str(fanin1)+") VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v/2' RISE=1\n\n")

        the_file.write("* inv" + name + "_2 delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_tfall TRIG V(n_1_"+str(fanin1)+") VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_trise TRIG V(n_1_"+str(fanin1)+") VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v/2' RISE=1\n\n")

        the_file.write("* Total delays\n")
        the_file.write(".MEASURE TRAN meaz1_total_tfall TRIG V(n_1_" +
                       str(fanin1)+") VAL='supply_v/2' FALL=1\n")
        the_file.write(
            "+    TARG V(n_1_"+str(fanin1 + tgatecount + 2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_total_trise TRIG V(n_1_" +
                       str(fanin1)+") VAL='supply_v/2' RISE=1\n")
        the_file.write(
            "+    TARG V(n_1_"+str(fanin1 + tgatecount + 2)+") VAL='supply_v/2' RISE=1\n\n")

    if fanin2 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand" + str(required_size) + "_" +
                       name + "_1_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand" + str(required_size) + "_" +
                       name + "_1_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v/2' RISE=1\n\n")

        the_file.write("* inv" + name + "_2 delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_" + name +
                       "_2_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_out) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_" + name +
                       "_2_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_out) VAL='supply_v/2' RISE=1\n\n")

        the_file.write("* Total delays\n")
        the_file.write(".MEASURE TRAN meaz2_total_tfall TRIG V(n_2_" +
                       str(fanin2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write(
            "+    TARG V(n_2_"+str(fanin2 + tgatecount + 2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_total_trise TRIG V(n_2_" +
                       str(fanin2)+") VAL='supply_v/2' RISE=1\n")
        the_file.write(
            "+    TARG V(n_2_"+str(fanin2 + tgatecount + 2)+") VAL='supply_v/2' RISE=1\n\n")
    ...
    if fanin1 != 0:
        ...
        the_file.write(
            ".MEASURE TRAN meaz1_avg_power PARAM = '-(meaz1_current/4n)*supply_v'\n\n")
    if fanin2 != 0:
        the_file.write(
            "* Measure the power required to propagate a rise and a fall transition through the subcircuit at 250MHz.\n")
        the_file.write(
        ...
        the_file.write(
            ".MEASURE TRAN meaz2_avg_power PARAM = '-(meaz2_current/4n)*supply_v'\n\n")
    ...
    if fanin1 != 0:
        ...
        the_file.write("Xwire0 n_1_0 n_1_1 wire Rw=wire_xconfigurabledecoderi_res/" +
                       str(fanin1)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin1)+"\n")
        for i in range(1, fanin1):
            the_file.write("Xloadnand"+str(i)+" n_1_"+str(i) +
                           " n_hang_"+str(i+1)+" vdd gnd xconfigurabledecoderiii\n")
            the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/" +
                           str(fanin1)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin1)+"\n")

        the_file.write("Xloadnand"+str(fanin1)+" n_1_"+str(fanin1)+" n_1_" +
                       str(fanin1 + 1)+" vdd_third1 gnd xconfigurabledecoderiii\n")
        # RAM load :
        the_file.write("Xwireadded n_1_"+str(fanin1 + 1)+" n_1_"+str(fanin1 + 2) +
                       " wire Rw=wire_xconfigurabledecoderiii_res Cw=wire_xconfigurabledecoderiii_cap \n")
        for i in range(fanin1 + 2, fanin1 + tgatecount + 2):
            the_file.write("Xwirel"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                           str(tgatecount)+" Cw=wire_memorycell_horizontal_cap/"+str(tgatecount)+"\n")
        the_file.write("Xtgate"+str(fanin1 + tgatecount)+" gnd gnd n_1_" +
                       str(fanin1 + tgatecount+2)+" vdd vdd gnd RAM_tgate\n")

    if fanin2 != 0:
        the_file.write("Xnandv n_in n_2_0 vdd gnd xconfigurabledecoder2ii\n")
        the_file.write("X2wire0 n_2_0 n_2_1 wire Rw=wire_xconfigurabledecoderi_res/" +
                       str(fanin2)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin2)+"\n")
        for i in range(1, fanin2):
            the_file.write("X2loadnand"+str(i)+" n_2_"+str(i) +
                           " n_hang2_"+str(i+1)+" vdd gnd xconfigurabledecoderiii\n")
            the_file.write("X2wire"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/" +
                           str(fanin2)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin2)+"\n")

        the_file.write("X2loadnand"+str(fanin2)+" n_2_"+str(fanin2)+" n_2_" +
                       str(fanin2 + 1)+" vdd_third1 gnd xconfigurabledecoderiii\n")
        # RAM load should be added here
        the_file.write("Xwireadded2 n_2_"+str(fanin2 + 1)+" n_2_"+str(fanin2 + 2) +
                       " wire Rw=wire_xconfigurabledecoderiii_res Cw=wire_xconfigurabledecoderiii_cap \n")
        for i in range(fanin2 + 2, fanin2 + tgatecount + 2):
            the_file.write("X2wirel"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                           str(tgatecount)+" Cw=wire_memorycell_horizontal_cap/"+str(tgatecount)+"\n")
        the_file.write("X2tgate"+str(fanin2 + tgatecount)+" gnd gnd n_2_" +
                       str(fanin2 + tgatecount+2)+" vdd vdd gnd RAM_tgate\n")
...
def generate_mtj_charge(name, colsize):
    ...
    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='supply_v_lp/2' FALL=1\n")
    the_file.write("+    TARG V(n_br_"+str(colsize) +
                   ") VAL='target_bl' RISE=1\n")
    ...
    the_file.write(
        ".MEASURE TRAN meas_outputtarget FIND V(n_br_"+str(colsize)+") AT=4n\n\n")

    the_file.write(
        "* Measure the power required to propagate a rise and a fall transition through the subcircuit at 250MHz.\n")
    the_file.write(
        ".MEASURE TRAN meas_current INTEGRAL I(V_charge) FROM=0ns TO=4ns\n")
    the_file.write(
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "Xprechargesa n_1_1 n_2_1 gnd gnd n_hang_out vclmpmtj vrefmtj gnd n_in_b vdd_charge gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "Xwritedriver gnd gnd n_1_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    the_file.write(
        "Xwritedriver_ref gnd gnd n_2_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "Xcs n_1_1 n_bl_0 n_in n_in_b vdd_lp gnd mtj_subcircuits_cs\n")
    the_file.write(
        "Xcs_ref n_2_1 n_br_0 n_in n_in_b vdd_lp gnd mtj_subcircuits_cs\n")
    # MTJ cells
    for i in range(0, colsize - 1):
        the_file.write("Xwire"+str(i)+" n_bl_"+str(i)+" n_bl_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
        the_file.write("XMTJ"+str(i)+" gnd gnd n_bl_" +
                       str(i + 1)+" gnd gnd gnd vdd_lp gnd memorycell\n")

        the_file.write("X2wire"+str(i)+" n_br_"+str(i)+" n_br_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
        the_file.write("X2MTJ"+str(i)+" gnd gnd n_br_" +
                       str(i + 1)+" gnd gnd gnd vdd_lp gnd memorycell\n")

    the_file.write("Xwire"+str(colsize)+" n_bl_"+str(colsize - 1)+" n_bl_"+str(colsize) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
    the_file.write("XMTJ"+str(colsize)+" vdd_lp gnd n_bl_" +
                   str(colsize)+" gnd  vdd_lp gnd mtjlow\n")

    the_file.write("X2wire"+str(colsize)+" n_br_"+str(colsize - 1)+" n_br_"+str(colsize) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
    the_file.write("X2MTJ"+str(colsize)+" vdd_lp gnd n_br_" +
                   str(colsize)+" gnd gnd gnd vdd_lp gnd memorycell\n")
...
def generate_mtj_sa_top(name, colsize):
    ...
    the_file.write("* Input signal\n")
    the_file.write(
        "VIN n_in gnd PULSE (0 supply_v_lp 'time_bl' 50p 50p 4n 8n)\n")
    ...
    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='supply_v_lp * 0.1' RISE=1\n")
    the_file.write("+    TARG V(n_hang_out) VAL='supply_v_lp * 0.95' RISE=1\n")
    # we are only measuring fall, so I just copy it down here for regularity
    the_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_in) VAL='supply_v_lp * 0.1' RISE=1\n")
    the_file.write(
        "+    TARG V(n_hang_out) VAL='supply_v_lp * 0.95' RISE=1 \n\n")
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "Xprechargesa n_1_1 n_2_1 n_in gnd n_hang_out vclmpmtj vrefmtj vdd_lp gnd vdd_charge gnd mtj_subcircuits_sa\n")

    the_file.write(
        "Xinv4 n_hang_out n_hang_out3 vdd_lp gnd inv_lp Wn = 180n Wp = 300\n")
    # MTJ write driver
    the_file.write(
        "Xwritedriver gnd gnd n_1_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    the_file.write(
    ...
    # MTJ CS
    the_file.write(
        "Xcs n_1_1 n_bl_0 n_inc n_inc_b vdd_lp gnd mtj_subcircuits_cs\n")
    #the_file.write("Xcs n_1_1 gnd n_inc n_inc_b vdd_lp gnd mtj_subcircuits_cs\n")
    the_file.write(
        "Xcs_ref n_2_1 n_br_0 n_inc n_inc_b vdd_lp gnd mtj_subcircuits_cs\n")
    # MTJ cells
    for i in range(0, colsize - 1):
        the_file.write("Xwire"+str(i)+" n_bl_"+str(i)+" n_bl_"+str(i+1)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
    ...
    the_file.write("X2wire"+str(colsize)+" n_br_"+str(colsize - 1)+" n_br_"+str(colsize) +
                   " wire Rw=wire_memorycell_vertical_res/"+str(colsize)+" Cw=wire_memorycell_vertical_cap/"+str(colsize)+"\n")
    the_file.write("X2MTJ"+str(colsize)+" vdd_lp gnd n_br_" +
                   str(colsize)+" gnd gnd gnd vdd_lp gnd memory_cell_ref\n")
...
def generate_mtj_discharge(name, colsize):
    ...
    the_file.write("+    TARG V(n_bl_"+str(colsize2) +
                   ") VAL='0.01 * supply_v_lp' FALL=1\n")
    # we are only measuring fall, so I just copy it down here for regularity
    the_file.write(
    ...
    the_file.write(
        "* Measure the power required to propagate a rise and a fall transition through the subcircuit at 250MHz.\n")
    the_file.write(
        ".MEASURE TRAN meas_current INTEGRAL I(V_discharge) FROM=0ns TO=4ns\n")
    if half == 0:
        the_file.write(
            ".MEASURE TRAN meas_avg_power PARAM = '-(meas_current/4n)*supply_v_lp'\n\n")
    else:
        the_file.write(
            ".MEASURE TRAN meas_avg_power PARAM = '-(meas_current/2n)*supply_v_lp'\n\n")
    ...
    # MTJ sense amp and precharge
    the_file.write(
        "Xprechargesa n_1_1 gnd vdd_lp gnd n_hang_out vclmpmtj vrefmtj gnd gnd vdd_lp gnd mtj_subcircuits_sa\n")
    # MTJ write driver
    the_file.write(
        "Xwritedriver gnd gnd n_1_1 gnd vdd_lp gnd mtj_subcircuits_writedriver\n")
    # MTJ CS
    the_file.write(
        "Xcs n_1_1 n_bl_0 n_in n_in_b vdd_discharge gnd mtj_subcircuits_cs\n")
    # MTJ cells
...
def generate_configurabledecoderiii_top_lp(name, fanin1, fanin2, required_size, tgatecount):
    ...
    if fanin1 != 0:
        the_file.write("* inv_nand" + str(required_size) +
                       "" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand" + str(required_size) + "_" +
                       name + "_1_tfall TRIG V(n_1_"+str(fanin1)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand" + str(required_size) + "_" +
                       name + "_1_trise TRIG V(n_1_"+str(fanin1)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v_lp/2' RISE=1\n\n")

        the_file.write("* inv" + name + "_2 delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_tfall TRIG V(n_1_"+str(fanin1)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_trise TRIG V(n_1_"+str(fanin1)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v_lp/2' RISE=1\n\n")

        the_file.write("* Total delays\n")
        the_file.write(".MEASURE TRAN meaz1_total_tfall TRIG V(n_1_" +
                       str(fanin1)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(n_1_"+str(fanin1 +
                       tgatecount + 2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_total_trise TRIG V(n_1_" +
                       str(fanin1)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(n_1_"+str(fanin1 +
                       tgatecount + 2)+") VAL='supply_v_lp/2' RISE=1\n\n")

    if fanin2 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand" + str(required_size) + "_" +
                       name + "_1_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand" + str(required_size) + "_" +
                       name + "_1_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v_lp/2' RISE=1\n\n")

        the_file.write("* inv" + name + "_2 delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_" + name +
                       "_2_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_out) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_" + name +
                       "_2_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_out) VAL='supply_v_lp/2' RISE=1\n\n")

        the_file.write("* Total delays\n")
        the_file.write(".MEASURE TRAN meaz2_total_tfall TRIG V(n_2_" +
                       str(fanin2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(n_2_"+str(fanin2 +
                       tgatecount + 2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_total_trise TRIG V(n_2_" +
                       str(fanin2)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(n_2_"+str(fanin2 +
                       tgatecount + 2)+") VAL='supply_v_lp/2' RISE=1\n\n")
    ...
    if fanin1 != 0:
        ...
        the_file.write("Xwire0 n_1_0 n_1_1 wire Rw=wire_xconfigurabledecoderi_res/" +
                       str(fanin1)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin1)+"\n")
        for i in range(1, fanin1):
            the_file.write("Xloadnand"+str(i)+" n_1_"+str(i)+" n_hang_" +
                           str(i+1)+" vdd_lp gnd xconfigurabledecoderiii\n")
            the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/" +
                           str(fanin1)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin1)+"\n")
        the_file.write("Xloadnand"+str(fanin1)+" n_1_"+str(fanin1)+" n_1_" +
                       str(fanin1 + 1)+" vdd_third1 gnd xconfigurabledecoderiii\n")
        ...
        for i in range(fanin1 + 2, fanin1 + tgatecount + 2):
            the_file.write("Xwirel"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                           str(tgatecount)+" Cw=wire_memorycell_horizontal_cap/"+str(tgatecount)+"\n")
        the_file.write("Xtgate"+str(fanin1 + tgatecount)+" gnd gnd n_1_" +
                       str(fanin1 + tgatecount+2)+" vdd_lp vdd_lp gnd RAM_tgate\n")
    ...
    if fanin2 != 0:
        ...
        the_file.write("X2wire0 n_2_0 n_2_1 wire Rw=wire_xconfigurabledecoderi_res/" +
                       str(fanin2)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin2)+"\n")
        for i in range(1, fanin2):
            the_file.write("X2loadnand"+str(i)+" n_2_"+str(i)+" n_hang2_" +
                           str(i+1)+" vdd_lp gnd xconfigurabledecoderiii\n")
            the_file.write("X2wire"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/" +
                           str(fanin2)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanin2)+"\n")
        the_file.write("X2loadnand"+str(fanin2)+" n_2_"+str(fanin2)+" n_2_" +
                       str(fanin2 + 1)+" vdd_third2 gnd xconfigurabledecoderiii\n")
        # RAM load should be added here
        the_file.write("Xwireadded2 n_2_"+str(fanin2 + 1)+" n_2_"+str(fanin2 + 2) +
                       " wire Rw=wire_xconfigurabledecoderiii_res Cw=wire_xconfigurabledecoderiii_cap \n")
        for i in range(fanin2 + 2, fanin2 + tgatecount + 2):
            the_file.write("X2wirel"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                           str(tgatecount)+" Cw=wire_memorycell_horizontal_cap/"+str(tgatecount)+"\n")
        the_file.write("X2tgate"+str(fanin2 + tgatecount)+" gnd gnd n_2_" +
                       str(fanin2 + tgatecount+2)+" vdd_lp vdd_lp gnd RAM_tgate\n")
        #the_file.write("X2loadnand3"+str(fanout1 + fanin2)+" n_2_"+str(fanout1 + fanin2)+" n_2_out vdd gnd thirdstage1\n")
...
def generate_rowdecoderstage3_top_lp(name, fanin1, fanin2, sramcount, number_of_banks, gate_type):
    ...
    if fanin1 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand"+str(gate_type)+"_" +
                       name + "_1_tfall TRIG V(n_1_1) VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand"+str(gate_type)+"_" +
                       name + "_1_trise TRIG V(n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v_lp/2' RISE=1\n\n")

        the_file.write("* inv" + name + "_2 delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_tfall TRIG V(n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_" + name +
                       "_2_trise TRIG V(n_1_1) VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v_lp/2' RISE=1\n\n")
    ...
    if fanin2 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand"+str(gate_type)+"_" + name +
                       "_1_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v_lp/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand"+str(gate_type)+"_" + name +
                       "_1_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v_lp/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v_lp/2' RISE=1\n\n")
    ...
    if fanin1 != 0:
        ...
        for i in range(1, fanin1):
            the_file.write("Xloadnand"+str(i)+" n_1_"+str(i) +
                           " n_hang_"+str(i+1)+" vdd_lp gnd rowdecoderstage3\n")
            the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/" +
                           str(fanin1)+" Cw=wire_rowdecoderstage0_cap/"+str(fanin1)+"\n")
        the_file.write("Xloadnand"+str(fanin1)+" n_1_"+str(fanin1) +
                       " n_1_"+str(fanin1 + 1)+" vdd_third1 gnd rowdecoderstage3\n")
        the_file.write("Xwordline n_1_"+str(fanin1 + 1)+" n_1_" +
                       str(fanin1 + 2)+" vdd_lp gnd wordline_driver\n")

    if fanin2 != 0:
        the_file.write("Xnandv n_in n_2_1 vdd_lp gnd rowdecoderstage13\n")
        for i in range(1, fanin2):
            the_file.write("X2loadnand"+str(i)+" n_2_"+str(i) +
                           " n_hang2_"+str(i+1)+" vdd_lp gnd rowdecoderstage3\n")
            the_file.write("X2wire"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/" +
                           str(fanin2)+" Cw=wire_rowdecoderstage0_cap/"+str(fanin2)+"\n")
        the_file.write("X2loadnand"+str(fanin2)+" n_2_"+str(fanin2) +
                       " n_2_"+str(fanin2 + 1)+" vdd_third2 gnd rowdecoderstage3\n")
        the_file.write("X2wordline n_2_"+str(fanin2 + 1)+" n_2_" +
                       str(fanin2 + 2)+" vdd_lp gnd wordline_driver\n")
...
def generate_wordline_driver_top_lp(name, sramcount, nandsize, smallrow, repeater):
    ...
    the_file.write(
        "********************************************************************************\n\n")
    the_file.write("* inv_" + name + " delay\n")
    the_file.write(".MEASURE TRAN meas_inv_nand"+str(nandsize) +
                   "_wordline_driver_1_tfall TRIG V(n_1_1) VAL='supply_v_lp/2' RISE=1\n")
    the_file.write("+    TARG V(Xwordline.n_1_1) VAL='supply_v_lp/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_nand"+str(nandsize) +
                   "_wordline_driver_1_trise TRIG V(n_1_1) VAL='supply_v_lp/2' FALL=1\n")
    the_file.write(
    ...
    the_file.write("+    TARG V(n_1_"+str(sramcount+1) +
                   ") VAL='supply_v_lp * 0.1' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_wordline_driver_4_trise TRIG V(n_1_1) VAL='supply_v_lp/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(sramcount+1) +
                   ") VAL='supply_v_lp * 0.9' RISE=1\n\n")
    ...
    for i in range(2, sramcount + 2):
        the_file.write("Xmemcell"+str(i)+" n_1_"+str(i) +
                       " gnd gnd gnd gnd gnd vdd_lp gnd memorycell\n")
        if repeater == 0:
            the_file.write("Xwirel"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_wordline_driver_res/" +
                           str(sramcount)+" Cw=wire_wordline_driver_cap/"+str(sramcount)+"\n")
        else:
            the_file.write("Xwirel"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_wordline_driver_res/" +
                           str(2*sramcount)+" Cw=wire_wordline_driver_cap/"+str(2*sramcount)+"\n")
...
def generate_rowdecoderstage3_top(name, fanin1, fanin2, sramcount, number_of_banks, gate_type):
    ...
    if fanin1 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand"+str(gate_type) +
                       "_" + name + "_1_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz1_inv_nand"+str(gate_type) +
                       "_" + name + "_1_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_1_1) VAL='supply_v/2' RISE=1\n\n")
        ...
        the_file.write("* Total delays\n")
        the_file.write(
            ".MEASURE TRAN meaz1_total_tfall TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v/2' FALL=1\n")
        the_file.write(
            ".MEASURE TRAN meaz1_total_trise TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(Xloadnand"+str(fanin1) +
                       ".n_out) VAL='supply_v/2' RISE=1\n\n")
    ...
    if fanin2 != 0:
        the_file.write("* inv_nand" + name + " delay\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand"+str(gate_type)+"_" + name +
                       "_1_tfall TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' RISE=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v/2' FALL=1\n")
        the_file.write(".MEASURE TRAN meaz2_inv_nand"+str(gate_type)+"_" + name +
                       "_1_trise TRIG V(n_2_"+str(fanin2)+") VAL='supply_v/2' FALL=1\n")
        the_file.write("+    TARG V(X2loadnand"+str(fanin2) +
                       ".n_1_1) VAL='supply_v/2' RISE=1\n\n")
    ...
    if fanin1 != 0:
        ...
        for i in range(1, fanin1):
            the_file.write("Xloadnand"+str(i)+" n_1_"+str(i) +
                           " n_hang_"+str(i+1)+" vdd gnd rowdecoderstage3\n")
            the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/" +
                           str(fanin1)+" Cw=wire_rowdecoderstage0_cap/"+str(fanin1)+"\n")
        the_file.write("Xloadnand"+str(fanin1)+" n_1_"+str(fanin1) +
                       " n_1_"+str(fanin1 + 1)+" vdd_third1 gnd rowdecoderstage3\n")
        the_file.write("Xwordline n_1_"+str(fanin1 + 1)+" n_1_" +
                       str(fanin1 + 2)+" vdd gnd wordline_driver\n")

    if fanin2 != 0:
        the_file.write("Xnandv n_in n_2_1 vdd gnd rowdecoderstage13\n")
        for i in range(1, fanin2):
            the_file.write("X2loadnand"+str(i)+" n_2_"+str(i) +
                           " n_hang2_"+str(i+1)+" vdd gnd rowdecoderstage3\n")
            the_file.write("X2wire"+str(i)+" n_2_"+str(i)+" n_2_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/" +
                           str(fanin2)+" Cw=wire_rowdecoderstage0_cap/"+str(fanin2)+"\n")
        the_file.write("X2loadnand"+str(fanin2)+" n_2_"+str(fanin2) +
                       " n_2_"+str(fanin2 + 1)+" vdd_third2 gnd rowdecoderstage3\n")
        the_file.write("X2wordline n_2_"+str(fanin2 + 1)+" n_2_" +
                       str(fanin2 + 2)+" vdd gnd wordline_driver\n")
...
def generate_rowdecoderstage1_top(name, fanout, size):
    ...
    the_file.write(".MEASURE TRAN meas_inv_nand" + str(size) + "_" +
                   name + "_1_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(Xsec.n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_nand" + str(size) + "_" +
                   name + "_1_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(Xsec.n_1_1) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* inv_" + name + " delay\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_tfall TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(1+fanout) +
                   ") VAL='supply_v/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_trise TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(1+fanout) +
                   ") VAL='supply_v/2' RISE=1\n\n")
    ...
    for i in range(2, 2+fanout):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/" +
                       str(fanout)+" Cw=wire_rowdecoderstage0_cap/"+str(fanout)+"\n")
        the_file.write("Xloadnand"+str(i)+" n_1_"+str(i) +
                       " n_hang_"+str(i+1)+" vdd gnd rowdecoderstage3\n")
...
def generate_rowdecoderstage1_top_lp(name, fanout, size):
    ...
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_tfall TRIG V(n_1_1) VAL='supply_v_lp/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(1+fanout) +
                   ") VAL='supply_v_lp/2' FALL=1\n")
    the_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_trise TRIG V(n_1_1) VAL='supply_v_lp/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(1+fanout) +
                   ") VAL='supply_v_lp/2' RISE=1\n\n")
...
def generate_configurabledecoder2ii_top(name, fanout, size):
    ...
    # wave shaping circuitry
    the_file.write(
        "xconfigurabledecoderi n_in n_1_1 vdd gnd xconfigurabledecoderi\n")
    ...
    for i in range(2, 2+fanout):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/" +
                       str(fanout)+" Cw=wire_xconfigurabledecoderi_cap/"+str(fanout)+"\n")
        the_file.write("Xloadnand"+str(i)+" n_1_"+str(i) +
                       " n_hang_"+str(i+1)+" vdd gnd xconfigurabledecoderiii\n")
...
def generate_rowdecoderstage0_top(name, numberofgates2, numberofgates3, decodersize, label2, label3):
    ...
    the_file.write(
        ".MEASURE TRAN meas_inv_rowdecoderstage0_1_tfall TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_rowdecoderstage0_1_trise TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' RISE=1\n\n")
    ...
    the_file.write(
        "Xinv_ff_output_driver n_1_3 n_1_4 vdd gnd inv Wn=inv_ff_output_driver_nmos Wp=inv_ff_output_driver_pmos\n")
    # Circuit Under test
    the_file.write("Xdstage0 n_1_4 n_1_5 vdd_test gnd rowdecoderstage0\n")
    # the load
    for i in range(5, int(numberofgates2)+5):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_rowdecoderstage0_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand2"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd gnd nand2 Wn=inv_nand2_rowdecoderstage12_1_nmos Wp=inv_nand2_rowdecoderstage12_1_pmos\n")
    for i in range(int(5 + numberofgates2), int(numberofgates2 + 5 + numberofgates3)):
        the_file.write("Xwire3"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_rowdecoderstage0_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand3"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd gnd nand3 Wn=inv_nand3_rowdecoderstage13_1_nmos Wp=inv_nand3_rowdecoderstage13_1_pmos\n")
...
def generate_rowdecoderstage0_top_lp(name, numberofgates2, numberofgates3, decodersize, label2, label3):
    ...
    for i in range(5, int(numberofgates2)+5):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_rowdecoderstage0_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand2"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd_lp gnd nand2_lp Wn=inv_nand2_rowdecoderstage12_1_nmos Wp=inv_nand2_rowdecoderstage12_1_pmos\n")
    for i in range(int(5 + numberofgates2), int(numberofgates2 + 5 + numberofgates3)):
        the_file.write("Xwire3"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_rowdecoderstage0_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_rowdecoderstage0_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand3"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd_lp gnd nand3_lp Wn=inv_nand3_rowdecoderstage13_1_nmos Wp=inv_nand3_rowdecoderstage13_1_pmos\n")
...
def generate_configurabledecoderi_top(name, numberofgates2, numberofgates3, ConfiDecodersize):
    ...
    the_file.write(
        ".MEASURE TRAN meas_inv_xconfigurabledecoderi_1_tfall TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_xconfigurabledecoderi_1_trise TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberofgates2 + 5 +
                   numberofgates3)+") VAL='supply_v/2' RISE=1\n\n")
    ...
    # the load
    for i in range(5, int(numberofgates2)+5):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_xconfigurabledecoderi_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand2"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd gnd nand2 Wn=inv_nand2_xconfigurabledecoder2ii_1_nmos Wp=inv_nand2_xconfigurabledecoder2ii_1_pmos\n")

    for i in range(int(5 + numberofgates2), int(numberofgates2 + 5 + numberofgates3)):
        the_file.write("Xwire3"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_xconfigurabledecoderi_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand3"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd gnd nand3 Wn=inv_nand3_xconfigurabledecoder3ii_1_nmos Wp=inv_nand3_xconfigurabledecoder3ii_1_pmos\n")
...
def generate_configurabledecoderi_top_lp(name, numberofgates2, numberofgates3, ConfiDecodersize):
    ...
    for i in range(5, int(numberofgates2)+5):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_xconfigurabledecoderi_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand2"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd_lp gnd nand2 Wn=inv_nand2_xconfigurabledecoder2ii_1_nmos Wp=inv_nand2_xconfigurabledecoder2ii_1_pmos\n")

    for i in range(int(5 + numberofgates2), int(numberofgates2 + 5 + numberofgates3)):
        the_file.write("Xwire3"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_xconfigurabledecoderi_res/"+str(
            numberofgates2+numberofgates3)+" Cw=wire_xconfigurabledecoderi_cap/"+str(numberofgates2+numberofgates3)+"\n")
        the_file.write("Xnand3"+str(i)+" n_1_"+str(i+1)+" n_hang_"+str(i) +
                       " vdd_lp gnd nand3 Wn=inv_nand3_xconfigurabledecoder3ii_1_nmos Wp=inv_nand3_xconfigurabledecoder3ii_1_pmos\n")
...
def generate_columndecoder_top(name, numberoftgates, decsize):
    ...
    the_file.write("* inv_columndecoder_1 delay\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_1_tfall TRIG V(Xdecorder.n_in) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(Xdecorder.n_1_1) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_1_trise TRIG V(Xdecorder.n_in) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(Xdecorder.n_1_1) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* inv_columndecoder_2 delay\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_2_tfall TRIG V(Xdecorder.n_in) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(Xdecorder.n_1_2) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_2_trise TRIG V(Xdecorder.n_in) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(Xdecorder.n_1_2) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* inv_columndecoder_3 delay\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_3_tfall TRIG V(Xdecorder.n_in) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberoftgates+5) +
                   ") VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_columndecoder_3_trise TRIG V(Xdecorder.n_in) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberoftgates+5) +
                   ") VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_1_3) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberoftgates+5) +
                   ") VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_1_3) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(n_1_"+str(numberoftgates+5) +
                   ") VAL='supply_v/2' RISE=1\n\n")
    ...
    for i in range(5, numberoftgates+5, 2):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                       str(numberoftgates)+" Cw=wire_memorycell_horizontal_cap/"+str(numberoftgates)+"\n")
        the_file.write("Xtgate"+str(i)+" gnd n_2_"+str(i) +
                       " gnd n_1_"+str(i+1)+" vdd gnd RAM_tgate\n")
        the_file.write("Xwire"+str(i+1)+" n_1_"+str(i+1)+" n_1_"+str(i+2)+" wire Rw=wire_memorycell_horizontal_res/" +
                       str(numberoftgates)+" Cw=wire_memorycell_horizontal_cap/"+str(numberoftgates)+"\n")
        the_file.write("Xtgate"+str(i+1)+" gnd n_2_"+str(i+1) +
                       " n_1_"+str(i+2)+" gnd vdd gnd RAM_tgate\n")
...
def generate_columndecoder_top_lp(name, numberoftgates, decsize):
    ...
    for i in range(5, numberoftgates+5, 2):
        the_file.write("Xwire"+str(i)+" n_1_"+str(i)+" n_1_"+str(i+1)+" wire Rw=wire_memorycell_horizontal_res/" +
                       str(numberoftgates)+" Cw=wire_memorycell_horizontal_cap/"+str(numberoftgates)+"\n")
        the_file.write("Xtgate"+str(i)+" gnd n_2_"+str(i) +
                       " gnd n_1_"+str(i+1)+" vdd_lp gnd RAM_tgate\n")
        the_file.write("Xwire"+str(i+1)+" n_1_"+str(i+1)+" n_1_"+str(i+2)+" wire Rw=wire_memorycell_horizontal_res/" +
                       str(numberoftgates)+" Cw=wire_memorycell_horizontal_cap/"+str(numberoftgates)+"\n")
        the_file.write("Xtgate"+str(i+1)+" gnd n_2_"+str(i+1) +
                       " n_1_"+str(i+2)+" gnd vdd_lp gnd RAM_tgate\n")
...
def generate_writedriver_top(name, numberofsrams):
    ...
    the_file.write(
        ".MEASURE TRAN meas_inv_writedriver_1_tfall TRIG V(xwrite.n_din) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(xwrite.n_dinb) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_writedriver_1_trise TRIG V(xwrite.n_din) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(xwrite.n_dinb) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* inv_writedriver_2 delay\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_writedriver_2_tfall TRIG V(xwrite.n_we) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(xwrite.n_web) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_inv_writedriver_2_trise TRIG V(xwrite.n_we) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(xwrite.n_web) VAL='supply_v/2' RISE=1\n\n")

    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='supply_v/2' RISE=1\n")
    the_file.write("+    TARG V(Xsram1.n_1_2) VAL='supply_v/2' FALL=1\n")
    the_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_in) VAL='supply_v/2' FALL=1\n")
    ...
    the_file.write(
        "X_inv_shape_0 n_in n_in1 vdd gnd inv Wn=inv_writedriver_1_nmos Wp=inv_writedriver_1_pmos\n")
    the_file.write(
        "X_inv_shape_1 n_in1 n_in_shaped vdd gnd inv Wn=inv_writedriver_1_nmos Wp=inv_writedriver_1_pmos\n")

    the_file.write(
        "X_inv_shape_2 we n_we vdd gnd inv Wn=inv_writedriver_1_nmos Wp=inv_writedriver_1_pmos\n")
    the_file.write(
        "X_inv_shape_3 n_we n_we_shaped vdd gnd inv Wn=inv_writedriver_1_nmos Wp=inv_writedriver_1_pmos\n")
    ...
    for i in range(2, numberofsrams+1):
        the_file.write("Xwire"+str(i)+" n_bl_"+str(i-1)+" n_bl_"+str(i)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
        the_file.write("Xwirer"+str(i)+" n_br_"+str(i-1)+" n_br_"+str(i)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
        the_file.write("Xsram"+str(i)+" gnd gnd n_bl_"+str(i) +
                       " gnd n_br_"+str(i)+" gnd vdd gnd memorycell\n")

    the_file.write("Xwire1 n_bl_0 n_bl_1 wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
    the_file.write("Xwirer1 n_br_0 n_br_1 wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
    ...
    # tgates on path:
    the_file.write("xtgate1 n_bl_"+str(numberofsrams) +
                   " tgate_l vdd gnd vdd gnd RAM_tgate\n")
    the_file.write("xtgater n_br_"+str(numberofsrams) +
                   " tgate_r vdd gnd vdd gnd RAM_tgate\n")
...
def generate_writedriver_top_lp(name, numberofsrams):
    ...
    for i in range(2, numberofsrams+1):
        ...
        the_file.write("Xwirer"+str(i)+" n_br_"+str(i-1)+" n_br_"+str(i)+" wire Rw=wire_memorycell_vertical_res/" +
                       str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
        the_file.write("Xsram"+str(i)+" gnd gnd n_bl_"+str(i) +
                       " gnd n_br_"+str(i)+" gnd vdd_lp gnd memorycell\n")
    ...
    # tgates on path:
    the_file.write("xtgate1 n_bl_"+str(numberofsrams) +
                   " tgate_l vdd_lp gnd vdd_lp gnd RAM_tgate_lp\n")
    the_file.write("xtgater n_br_"+str(numberofsrams) +
                   " tgate_r vdd_lp gnd vdd_lp gnd RAM_tgate_lp\n")
    # samp and write driver:
...
def generate_samp_top_part2(name, numberofsrams, difference):
    ...
    the_file.write("Xwire"+str(1)+" n_bl_"+str(0)+" n_bl_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
    the_file.write("Xwirer"+str(1)+" n_br_"+str(0)+" n_br_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")

    the_file.write("Xsram"+str(1)+" gnd gnd n_bl_"+str(1) +
                   " gnd n_br_"+str(1)+" gnd vdd gnd memorycell\n")
...
def generate_samp_top_part2_lp(name, numberofsrams, difference):
    ...
    the_file.write("Xwirer"+str(1)+" n_br_"+str(0)+" n_br_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
    the_file.write("Xsram"+str(1)+" gnd gnd n_bl_"+str(1) +
                   " gnd n_br_"+str(1)+" gnd vdd_lp gnd memorycell\n")
    the_file.write("Iread n_br_"+str(1)+" gnd PULSE(0 Rcurrent 0 0 0 4n 8n)\n")
...
def generate_samp_top(name, numberofsrams):
    ...
    the_file.write("Xwirer"+str(1)+" n_br_"+str(0)+" n_br_"+str(1)+" wire Rw=wire_memorycell_vertical_res/" +
                   str(numberofsrams)+" Cw=wire_memorycell_vertical_cap/"+str(numberofsrams)+"\n")
    the_file.write("Xsram"+str(1)+" wordline gnd n_bl_"+str(1) +
                   " gnd n_br_"+str(1)+" gnd vdd gnd memorycell\n")
...
def generate_precharge_top(name, numberofsrams):
    ...
    the_file.write("* Total delays\n")
    the_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(v_precharge) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_bl_"+str(numberofsrams2) +
                   ") VAL='0.99*supply_v' RISE=1\n")
    the_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(v_precharge) VAL='supply_v/2' FALL=1\n")
    the_file.write("+    TARG V(n_bl_"+str(numberofsrams2) +
                   ") VAL='0.99*supply_v' RISE=1\n\n")
    ...
    if half == 0:
        ...
        the_file.write(
            ".MEASURE TRAN meas_avg_power PARAM = '-(meas_current/2n)*supply_v'\n\n")
    ...
    the_file.write(
        "********************************************************************************\n\n")
    the_file.write(
        "xinv n_in v_precharge vdd gnd inv l=gate_length w=2*gate_length\n")
    the_file.write(
    ...
    for i in range(1, numberofsrams2+1):
        ...
        the_file.write("Xsram"+str(i)+" gnd gnd n_bl_"+str(i) +
                       " gnd n_br_"+str(i)+" gnd vdd gnd memorycell\n")
    # tgates on path:
    the_file.write("xtgate1 n_bl_"+str(numberofsrams2) +
                   " tgate_l vdd gnd vdd gnd RAM_tgate\n")
    the_file.write("xtgater n_br_"+str(numberofsrams2) +
                   " tgate_r vdd gnd vdd gnd RAM_tgate\n")
    # samp and column decoder:
    the_file.write("xwrite gnd gnd tgate_l tgate_r vdd gnd writedriver\n")
...
def generate_HB_local_mux_top(mux_name, name):
    ...
    local_mux_file.write(".MEASURE TRAN meas_inv_"+mux_name +
                         "_1_tfall TRIG V(Xlocal_routing_wire_load_1.Xlocal_mux_on_1.n_in) VAL='supply_v/2' FALL=1\n")
    local_mux_file.write(
        "+    TARG V(Xlocal_routing_wire_load_1.Xlocal_mux_on_1.n_1_1) VAL='supply_v/2' FALL=1\n")
    local_mux_file.write(".MEASURE TRAN meas_inv_"+mux_name +
                         "_1_trise TRIG V(Xlocal_routing_wire_load_1.Xlocal_mux_on_1.n_in) VAL='supply_v/2' RISE=1\n")
    local_mux_file.write(
    ...
    local_mux_file.write(".MEASURE TRAN meas_inv_"+mux_name +
                         "_2_tfall TRIG V(Xlocal_routing_wire_load_1.Xlocal_mux_on_1.n_in) VAL='supply_v/2' FALL=1\n")
    local_mux_file.write("+    TARG V(n_1_5) VAL='supply_v/2' FALL=1\n")
    local_mux_file.write(".MEASURE TRAN meas_inv_"+mux_name +
                         "_2_trise TRIG V(Xlocal_routing_wire_load_1.Xlocal_mux_on_1.n_in) VAL='supply_v/2' RISE=1\n")
    ...
    local_mux_file.write(
        "Xrouting_wire_load_1 n_1_1 n_1_2 n_1_3 vsram vsram_n vdd gnd vdd vdd routing_wire_load\n")
    local_mux_file.write(
        "Xlocal_routing_wire_load_1 n_1_3 n_1_4 vsram vsram_n vdd gnd vdd_local_mux "+name+"_local_routing_wire_load\n")
    ...
    local_mux_file.write("Xwirer_edi n_1_4 n_1_5 wire Rw=wire_" +
                         name+"_1_res Cw=wire_"+name+"_1_cap \n")
    local_mux_file.write(
...
def generate_RAM_local_mux_top_lp(mux_name):
    ...
    local_mux_file.write(
        ".MEASURE TRAN meas_logic_low_voltage FIND V(n_in) AT=3n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test1 FIND V(n_1_5) AT=1.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test11 FIND V(XCSVL.n_in) AT=1.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test12 FIND V(XCSVL.n_1_1) AT=1.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test13 FIND V(XCSVL.n_out) AT=1.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test14 FIND V(XCSVL.n_out_b) AT=1.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test31 FIND V(n_1_5) AT=3.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test15 FIND V(XCSVL.n_in) AT=3.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test16 FIND V(XCSVL.n_1_1) AT=3.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test17 FIND V(XCSVL.n_out) AT=3.99n\n\n")  # check
    local_mux_file.write(
        ".MEASURE TRAN test18 FIND V(XCSVL.n_out_b) AT=3.99n\n\n")  # check
    local_mux_file.write(
        "* Measure the power required to propagate a rise and a fall transition through the subcircuit at 250MHz.\n")
    local_mux_file.write(
        ".MEASURE TRAN meas_current INTEGRAL I(V_LOCAL_MUX) FROM=0ns TO=4ns\n")
    ...
    local_mux_file.write(
        "Xff n_1_5 n_hang1 vsram vsram_n vdd_lp gnd gnd vdd_lp gnd vdd_lp vdd gnd ff\n\n")
    # im putting a flip flop here for now, if we are going to move it, this needs to change.
    local_mux_file.write(".END")
    local_mux_file.close()
...
def generate_lut6_top(lut_name, use_tgate):
    ...
    if not use_tgate:
        ...
        lut_file.write(
            "Xlut n_in n_out vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd lut\n\n")
        lut_file.write(
            "Xlut_output_load n_out n_local_out n_general_out vsram vsram_n vdd gnd vdd vdd lut_output_load\n\n")
...
def generate_lut_driver_top(input_driver_name, input_driver_type):
    ...
    if input_driver_type != "default":
        ...
        input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                                "_0_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
        input_driver_file.write(
            "+    TARG V(X" + input_driver_name + "_1.n_1_1) VAL='supply_v/2' FALL=1\n")
        input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                                "_0_trise TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
        input_driver_file.write(
            "+    TARG V(X" + input_driver_name + "_1.n_1_1) VAL='supply_v/2' RISE=1\n\n")
        input_driver_file.write("* inv_" + input_driver_name + "_1 delays\n")
        input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                                "_1_tfall TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
        input_driver_file.write(
            "+    TARG V(X" + input_driver_name + "_1.n_3_1) VAL='supply_v/2' FALL=1\n")
        input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                                "_1_trise TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
        input_driver_file.write(
            "+    TARG V(X" + input_driver_name + "_1.n_3_1) VAL='supply_v/2' RISE=1\n\n")
    input_driver_file.write("* inv_" + input_driver_name + "_2 delays\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_2_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    input_driver_file.write("+    TARG V(n_out) VAL='supply_v/2' FALL=1\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_2_trise TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    ...
    input_driver_file.write("X" + input_driver_name +
                            "_1 n_1_2 n_out vsram vsram_n n_rsel n_2_1 vdd_lut_driver gnd " + input_driver_name + "\n")
    ...
    input_driver_file.write("X" + input_driver_name +
                            "_not_1 n_2_1 n_out_n vdd gnd " + input_driver_name + "_not\n")
    input_driver_file.write("X" + input_driver_name +
                            "_load_1 n_out vdd gnd " + input_driver_name + "_load\n")
    input_driver_file.write("X" + input_driver_name +
                            "_load_2 n_out_n vdd gnd " + input_driver_name + "_load\n\n")
...
def generate_lut_driver_not_top(input_driver_name, input_driver_type):
    ...
    input_driver_file.write("* inv_" + input_driver_name + "_1 delays\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_1_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    input_driver_file.write(
        "+    TARG V(X" + input_driver_name + "_1.n_1_1) VAL='supply_v/2' FALL=1\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_1_trise TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    input_driver_file.write(
        "+    TARG V(X" + input_driver_name + "_1.n_1_1) VAL='supply_v/2' RISE=1\n\n")
    input_driver_file.write("* inv_" + input_driver_name + "_2 delays\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_2_tfall TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    input_driver_file.write("+    TARG V(n_out_n) VAL='supply_v/2' FALL=1\n")
    input_driver_file.write(".MEASURE TRAN meas_inv_" + input_driver_name +
                            "_2_trise TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    ...
    input_driver_file.write(
        "Xlocal_routing_wire_load_1 n_1_1 n_1_2 vsram vsram_n vdd gnd vdd local_routing_wire_load\n")
    input_driver_file.write("X" + input_driver_name_no_not +
                            "_1 n_1_2 n_out vsram vsram_n n_rsel n_2_1 vdd gnd " + input_driver_name_no_not + "\n")
    if input_driver_type == "default_rsel" or input_driver_type == "reg_fb_rsel":
        # Connect a load to n_rsel node
        input_driver_file.write(
            "Xff n_rsel n_ff_out vsram vsram_n gnd vdd gnd vdd gnd vdd vdd gnd ff\n")
    input_driver_file.write("X" + input_driver_name +
                            "_1 n_2_1 n_out_n vdd_lut_driver gnd " + input_driver_name + "\n")
    input_driver_file.write("X" + input_driver_name_no_not +
                            "_load_1 n_out n_vdd n_gnd " + input_driver_name_no_not + "_load\n")
    input_driver_file.write("X" + input_driver_name_no_not +
                            "_load_2 n_out_n n_vdd n_gnd " + input_driver_name_no_not + "_load\n\n")
    input_driver_file.write(".END")
    input_driver_file.close()
...
def generate_lut_and_driver_top(input_driver_name, input_driver_type, use_tgate, use_fluts):
    ...
    spice_file.write(
        "Xlocal_routing_wire_load_1 n_1_1 n_1_2 vsram vsram_n vdd gnd vdd local_routing_wire_load\n")
    spice_file.write("X" + input_driver_name +
                     "_1 n_1_2 n_3_1 vsram vsram_n n_rsel n_2_1 vdd gnd " + input_driver_name + "\n")
    ...
    if input_driver_type == "default_rsel" or input_driver_type == "reg_fb_rsel":
        spice_file.write(
            "Xff n_rsel n_ff_out vsram vsram_n gnd vdd gnd vdd gnd vdd vdd gnd ff\n")
    spice_file.write("X" + input_driver_name +
                     "_not_1 n_2_1 n_1_4 vdd gnd " + input_driver_name + "_not\n")
    ...
    spice_file.write("Xlut n_in_sram n_out " +
                     lut_input_nodes + "vdd_lut gnd lut\n")
...
def generate_local_ble_output_top(name, use_tgate):
    ...
    if not use_tgate:
        ...
        top_file.write(
            "Xlut n_in n_1_1 vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd vdd gnd lut\n\n")
        top_file.write(
            "Xlut_output_load n_1_1 n_local_out n_general_out vsram vsram_n vdd gnd vdd_local_output vdd lut_output_load\n\n")
...
def generate_flut_mux_top(name, use_tgate, enable_carry_chain):
    ...
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    ...
    if not use_tgate:
        ...
        if enable_carry_chain == 1:
            ...
            top_file.write(
                "Xccmux n_1_4 n_local_out vdd gnd vdd gnd carry_chain_mux\n")
        else:
            top_file.write(
...
def generate_cc_mux_top(name, use_tgate):
    ...
    top_file.write("* inv_" + name + "_1 delay\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_tfall TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(Xthemux.n_2_1) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_trise TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(Xthemux.n_2_1) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("* inv_" + name + "_2 delays\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_tfall TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_local_out) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_trise TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(n_local_out) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("* Total delays\n")
    top_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    #top_file.write("+    TARG V(n_1_3) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_local_out) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_1_4) VAL='supply_v/2' RISE=1\n")
    #top_file.write("+    TARG V(n_1_3) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("+    TARG V(n_local_out) VAL='supply_v/2' RISE=1\n\n")
    top_file.write(
        ".MEASURE TRAN meas_logic_low_voltage FIND V(n_general_out) AT=3n\n\n")
    ...
    top_file.write(
        "Xcarrychain_shape1 vdd gnd n_in n_1_1 n_hang n_p_1 vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain_shape2 vdd gnd n_1_1 n_1_2 n_hang_2 n_p_2 vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain_shape3 vdd gnd n_1_2 n_hang_3 n_1_3 n_p_3 vdd gnd FA_carry_chain\n")
    top_file.write("Xinv_shape n_1_3 n_1_4 vdd gnd carry_chain_perf\n")
    top_file.write(
        "Xthemux n_1_4 n_1_5 vdd gnd vdd_test gnd carry_chain_mux\n")
    top_file.write(
        "Xlut_output_load n_1_5 n_local_out n_general_out vsram vsram_n vdd gnd vdd vdd lut_output_load\n\n")
...
def generate_carry_chain_ripple_top(name):
    ...
    top_file.write("* inv_carry_chain_1 delay\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_perf_1_tfall TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_out) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_perf_1_trise TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    ...
    top_file.write(
        "* Measure the power required to propagate a rise and a fall transition through the subcircuit at 250MHz.\n")
    top_file.write(
        ".MEASURE TRAN meas_current INTEGRAL I(V_test) FROM=0ns TO=26ns\n")
    top_file.write(
        ".MEASURE TRAN meas_avg_power PARAM = '-((meas_current)/26n)*supply_v'\n\n")
    ...
    top_file.write(
        "Xcarrychain_shape1 vdd gnd n_in n_1_1 n_hang n_p_1 vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain_shape2 vdd gnd n_1_1 n_1_2 n_hang_s n_p_2 vdd gnd FA_carry_chain\n")

    # Generate the uni under test:
    top_file.write(
        "Xcarrychain_main vdd gnd n_1_2 n_hang_2 n_1_3 n_p_3 vdd gnd FA_carry_chain\n")
...
def generate_carrychain_top(name):
    ...
    top_file.write("* inv_carry_chain_1 delay\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_1_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    top_file.write(
        "+    TARG V(Xcarrychain.n_cin_in_bar) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_1_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        "+    TARG V(Xcarrychain.n_cin_in_bar) VAL='supply_v/2' RISE=1\n\n")

    top_file.write("* inv_carry_chain_2 delays\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_2_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(n_sum_out) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        ".MEASURE TRAN meas_inv_carry_chain_2_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_sum_out) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("* Total delays\n")

    top_file.write(
        ".MEASURE TRAN meas_total_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        ".MEASURE TRAN meas_total_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
    ...
    # Generate Cin as part of wave-shaping circuitry:
    top_file.write(
        "Xcarrychain_shape vdd gnd n_in n_0_1 n_hang n_p_1 vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain_shape1 vdd gnd n_0_1 n_0_2 n_hangz n_p_0 vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain_shape2 vdd gnd n_0_2 n_1_1 n_hangzz n_p_z vdd gnd FA_carry_chain\n")

    # Generate the adder under test:
    top_file.write(
        "Xcarrychain vdd gnd n_1_1 n_1_2 n_sum_out n_p_2 vdd_test gnd FA_carry_chain\n")

    # cout typical load
    top_file.write(
        "Xcarrychain_load vdd gnd n_1_2 n_1_3 n_sum_out2 n_p_3 vdd gnd FA_carry_chain\n")
...
def generate_carry_inter_top(name):
    ...
    # Generate Cin as part of wave-shaping circuitry:
    top_file.write(
        "Xcarrychain_0 vdd gnd n_in n_1_1 n_sum_out n_1p vdd gnd FA_carry_chain\n")
    top_file.write(
        "Xcarrychain vdd gnd n_1_1 n_1_2 n_sum_out2 n_2p vdd gnd FA_carry_chain\n")
    ...
    top_file.write(
        "Xcarrychain_l n_1_3 vdd gnd n_hangl n_sum_out3 n_3p vdd gnd FA_carry_chain\n")
...
def generate_carrychainand_top(name, use_tgate, nand1_size, nand2_size):
    ...
    top_file.write(
        "********************************************************************************\n\n")
    top_file.write("* inv_nand"+name+"_1 delay\n")
    top_file.write(".MEASURE TRAN meas_inv_nand"+str(nand1_size) +
                   "_"+name+"_1_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(Xandtree.n_1_2) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_nand"+str(nand1_size) +
                   "_"+name+"_1_trise TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    ...
    top_file.write(".MEASURE TRAN meas_inv_nand"+str(nand2_size) +
                   "_"+name+"_3_tfall TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(Xandtree.n_1_5) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_nand"+str(nand2_size) +
                   "_"+name+"_3_trise TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(Xandtree.n_1_5) VAL='supply_v/2' RISE=1\n\n")

    top_file.write("* inv_"+name+"_4 delays\n")
    top_file.write(".MEASURE TRAN meas_inv_"+name +
                   "_4_tfall TRIG V(n_1_2) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_1_3) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_"+name +
                   "_4_trise TRIG V(n_1_2) VAL='supply_v/2' RISE=1\n")
    top_file.write("+    TARG V(n_1_3) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("* Total delays\n")
    ...
    top_file.write(
        "Xcarrychain n_1_1 vdd gnd n_hang n_sum_out n_1_2 vdd gnd FA_carry_chain\n")
    # Generate the unit under test:
    top_file.write("Xandtree n_1_2 n_1_3 vdd_test gnd xcarry_chain_and\n")
    # typical load
    top_file.write(
        "Xcarrychainskip_mux n_1_3 n_1_4 vdd gnd vdd gnd xcarry_chain_mux\n")
    top_file.write(
        "Xcarrychain_mux n_1_4 n_1_5 vdd gnd vdd gnd carry_chain_mux\n")
...
def generate_skip_mux_top(name, use_tgate):
    ...
    top_file.write("* inv_" + name + "_1 delay\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_tfall TRIG V(n_1_3) VAL='supply_v/2' RISE=1\n")
    top_file.write(
        "+    TARG V(Xcarrychainskip_mux.n_2_1) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_1_trise TRIG V(n_1_3) VAL='supply_v/2' FALL=1\n")
    top_file.write(
        "+    TARG V(Xcarrychainskip_mux.n_2_1) VAL='supply_v/2' RISE=1\n\n")
    top_file.write("* inv_" + name + "_2 delays\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_tfall TRIG V(n_1_3) VAL='supply_v/2' FALL=1\n")
    top_file.write("+    TARG V(n_1_4) VAL='supply_v/2' FALL=1\n")
    top_file.write(".MEASURE TRAN meas_inv_" + name +
                   "_2_trise TRIG V(n_1_3) VAL='supply_v/2' RISE=1\n")
    ...
    # Generate the unit under test:
    top_file.write(
        "Xcarrychainskip_mux n_1_3 n_1_4 vdd gnd vdd_test gnd xcarry_chain_mux\n")
    # typical load
    top_file.write(
        "Xcarrychain_mux n_1_4 n_1_5 vdd gnd vdd gnd carry_chain_mux\n")
...
def generate_dedicated_driver_top(name, top_name, num_bufs):
    ...
    for i in range(1, num_bufs * 2 + 1, 2):
        ...
        top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                       str(i)+"_tfall TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
        top_file.write("+    TARG V(Xdriver.n_1_"+str(2 * i) +
                       ") VAL='supply_v/2' FALL=1\n")
        top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                       str(i)+"_trise TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
        top_file.write("+    TARG V(Xdriver.n_1_"+str(2 * i) +
                       ") VAL='supply_v/2' RISE=1\n\n")
        if i + 1 == num_bufs * 2:
            top_file.write("* inv_" + name + "_"+str(i+1)+" delays\n")
            top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                           str(i+1)+"_tfall TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
            top_file.write(
                "+    TARG V(Xdriver.n_out) VAL='supply_v/2' FALL=1\n")
            top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                           str(i+1)+"_trise TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
            top_file.write(
            ...
            top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                           str(i+1)+"_tfall TRIG V(n_1_1) VAL='supply_v/2' FALL=1\n")
            top_file.write("+    TARG V(Xdriver.n_1_" +
                           str(2 * i + 2)+") VAL='supply_v/2' FALL=1\n")
            top_file.write(".MEASURE TRAN meas_inv_" + name + "_" +
                           str(i+1)+"_trise TRIG V(n_1_1) VAL='supply_v/2' RISE=1\n")
            top_file.write("+    TARG V(Xdriver.n_1_" +
                           str(2 * i + 2)+") VAL='supply_v/2' RISE=1\n\n")
    ...
    # typical load
    top_file.write("Xwirer_edi n_1_2 n_1_3 wire Rw=wire_" +
                   top_name+"_2_res Cw=wire_"+top_name+"_2_cap \n")
    top_file.write(
