...
def generate_ptran_lut6(spice_filename, min_tran_width, use_finfet):
    ...
    if not use_finfet:
        spice_file.write(
            "Xinv_lut_sram_driver_1 n_in n_1_1 n_vdd n_gnd inv Wn="
            + str(Wn)
            + "n Wp="
            + str(Wp)
            + "n\n"
        ...
        spice_file.write(
            "Xinv_lut_sram_driver_1 n_in n_1_1 n_vdd n_gnd inv Wn=1 Wp=1\n"
        )
...
def generate_ptran_lut4(spice_filename, min_tran_width, use_finfet):
    ...
    spice_file.write(
        "Xwire_lut_int_buffer n_5_1 n_5_2 wire Rw=wire_lut_int_buffer_res Cw=wire_lut_int_buffer_cap\n"
    )
    spice_file.write(
        "Xinv_lut_int_buffer_2 n_5_2 n_6_1 n_vdd n_gnd inv Wn=inv_lut_int_buffer_2_nmos Wp=inv_lut_int_buffer_2_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_int_buffer_out n_6_1 n_6_2 wire Rw=wire_lut_int_buffer_out_res Cw=wire_lut_int_buffer_out_cap\n\n"
    )

    spice_file.write("* Second chain\n")
    spice_file.write(
        "Xptran_lut_L3 n_6_2 n_7_1 n_c n_gnd ptran Wn=ptran_lut_L3_nmos\n")
    spice_file.write(
        "Xwire_lut_L3 n_7_1 n_7_2 wire Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n"
    )
    spice_file.write(
        "Xwire_lut_L3h n_7_2 n_7_3 wire Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n"
    )
    spice_file.write(
        "Xptran_lut_L3h n_gnd n_7_3 n_gnd n_gnd ptran Wn=ptran_lut_L3_nmos\n"
    )
    spice_file.write(
        "Xptran_lut_L4 n_7_2 n_8_1 n_d n_gnd ptran Wn=ptran_lut_L4_nmos\n")
    spice_file.write(
    ...
    spice_file.write(
        "Xwire_lut_out_buffer n_9_1 n_9_2 wire Rw=wire_lut_out_buffer_res Cw=wire_lut_out_buffer_cap\n"
    )
    spice_file.write(
        "Xinv_lut_out_buffer_2 n_9_2 n_out n_vdd n_gnd inv Wn=inv_lut_out_buffer_2_nmos Wp=inv_lut_out_buffer_2_pmos\n\n"
    )
    spice_file.write(".ENDS\n\n\n")
...
def generate_ptran_lut_driver(spice_filename, lut_input_name, lut_input_type):
    ...
    spice_file.write(
        ".SUBCKT "
        + lut_input_name
        + " n_in n_out n_gate n_gate_n n_rsel n_not_input n_vdd n_gnd\n"
    )
    ...
    if lut_input_type != "default":
        spice_file.write(
            "Xinv_"
            + lut_input_name
            + "_0 n_in n_1_1 n_vdd n_gnd inv Wn=inv_"
            + lut_input_name
            + "_0_nmos Wp=inv_"
            + lut_input_name
            + "_0_pmos\n"
        ...
        if lut_input_type == "default_rsel" or lut_input_type == "reg_fb_rsel":
            spice_file.write(
                "Xwire_"
                + lut_input_name
                + "_0_rsel n_1_1 n_rsel wire Rw=wire_"
                + lut_input_name
                + "_0_rsel_res Cw=wire_"
                + lut_input_name
                + "_0_rsel_cap\n"
            )
        ...
        spice_file.write(
            "Xwire_"
            + lut_input_name
            + "_0_out n_1_1 n_1_2 wire Rw=wire_"
            + lut_input_name
            + "_0_out_res Cw=wire_"
            + lut_input_name
            + "_0_out_cap\n"
        ...
        if lut_input_type == "default_rsel":
            spice_file.write(
                "Xinv_"
                + lut_input_name
                + "_1 n_1_2 n_3_1 n_vdd n_gnd inv Wn=inv_"
                + lut_input_name
                + "_1_nmos Wp=inv_"
                + lut_input_name
                + "_1_pmos\n"
            ...
            spice_file.write(
                "Xptran_"
                + lut_input_name
                + "_0 n_1_2 n_2_1 n_gate n_gnd ptran Wn=ptran_"
                + lut_input_name
                + "_0_nmos\n"
            )
            spice_file.write(
            ...
            spice_file.write(
                "Xptran_"
                + lut_input_name
                + "_0h n_gnd n_2_3 n_gate_n n_gnd ptran Wn=ptran_"
                + lut_input_name
                + "_0_nmos\n"
            )
            spice_file.write(
                "Xrest_"
                + lut_input_name
                + " n_2_2 n_3_1 n_vdd n_gnd rest Wp=rest_"
                + lut_input_name
                + "_pmos\n"
            )
            spice_file.write(
                "Xinv_"
                + lut_input_name
                + "_1 n_2_2 n_3_1 n_vdd n_gnd inv Wn=inv_"
                + lut_input_name
                + "_1_nmos Wp=inv_"
                + lut_input_name
                + "_1_pmos\n"
        ...
        spice_file.write(
            "Xwire_"
            + lut_input_name
            + " n_3_1 n_not_input wire Rw=wire_"
            + lut_input_name
            + "_res Cw=wire_"
            + lut_input_name
            + "_cap\n"
        ...
        spice_file.write(
            "Xinv_"
            + lut_input_name
            + "_2 n_not_input n_out n_vdd n_gnd inv Wn=inv_"
            + lut_input_name
            + "_2_nmos Wp=inv_"
            + lut_input_name
            + "_2_pmos\n"
    ...
    # This is convenient for writing the top-level SPICE file.
        ...
        spice_file.write(
            "Xwire_"
            + lut_input_name
            + " n_in n_not_input wire Rw=wire_"
            + lut_input_name
            + "_res Cw=wire_"
            + lut_input_name
            + "_cap\n"
...
def generate_ptran_lut_not_driver(spice_filename, lut_input_name):
    ...
    spice_file.write(
        "Xinv_"
        + lut_input_name
        + "_1 n_in n_1_1 n_vdd n_gnd inv Wn=inv_"
        + lut_input_name
        + "_1_nmos Wp=inv_"
        + lut_input_name
        + "_1_pmos\n"
    ...
    spice_file.write(
        "Xinv_"
        + lut_input_name
        + "_2 n_1_2 n_out n_vdd n_gnd inv Wn=inv_"
        + lut_input_name
        + "_2_nmos Wp=inv_"
        + lut_input_name
        + "_2_pmos\n"
...
def generate_ptran_lut_driver_load(spice_filename, lut_input_name, K, use_fluts):
    ...
    spice_file.write(".SUBCKT lut_" + lut_input_name +
                     "_driver_load n_1 n_vdd n_gnd\n")
    for ptran in range(num_ptran_load):
        ...
        if use_fluts and num_ptran_load == 1:
            spice_file.write(
                ...
                + " n_gnd n_gnd n_"
                + str(ptran + 1)
                + " n_gnd ptran Wn=ptran_flut_mux_nmos\n"
            )
        else:
            spice_file.write(
                "Xptran_lut_"
...
def generate_tgate_lut6(spice_filename, min_tran_width, use_finfet):
    ...
    spice_file.write(
        ".SUBCKT lut n_in n_out n_a n_a_n n_b n_b_n n_c n_c_n n_d n_d_n n_e n_e_n n_f n_f_n n_vdd n_gnd\n"
    )
    Wn = min_tran_width
    Wp = 1.667 * min_tran_width
    ...
    if not use_finfet:
        ...
        spice_file.write(
            "Xinv_lut_sram_driver_1 n_in n_1_1 n_vdd n_gnd inv Wn=1 Wp=2 \n"
        )
    ...
    spice_file.write("* First chain\n")
    spice_file.write(
        "Xtgate_lut_L1 n_2_2 n_3_1 n_a n_a_n n_vdd n_gnd tgate Wn=tgate_lut_L1_nmos Wp=tgate_lut_L1_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L1 n_3_1 n_3_2 wire Rw='wire_lut_L1_res/2' Cw='wire_lut_L1_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L1h n_gnd n_3_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L1_nmos Wp=tgate_lut_L1_pmos\n"
    )
    spice_file.write(
        "Xtgate_lut_L2 n_3_2 n_4_1 n_b n_b_n n_vdd n_gnd tgate Wn=tgate_lut_L2_nmos Wp=tgate_lut_L2_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L2 n_4_1 n_4_2 wire Rw='wire_lut_L2_res/2' Cw='wire_lut_L2_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L2h n_gnd n_4_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L2_nmos Wp=tgate_lut_L2_pmos\n"
    )
    spice_file.write(
        "Xtgate_lut_L3 n_4_2 n_5_1 n_c n_c_n n_vdd n_gnd tgate Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L3 n_5_1 n_5_2 wire Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L3h n_gnd n_5_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_pmos\n\n"
    )
    ...
    spice_file.write("* Second chain\n")
    spice_file.write(
        "Xtgate_lut_L4 n_7_2 n_8_1 n_d n_d_n n_vdd n_gnd tgate Wn=tgate_lut_L4_nmos Wp=tgate_lut_L4_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L4 n_8_1 n_8_2 wire Rw='wire_lut_L4_res/2' Cw='wire_lut_L4_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L4h n_gnd n_8_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L4_nmos Wp=tgate_lut_L4_pmos\n"
    )
    spice_file.write(
        "Xtgate_lut_L5 n_8_2 n_9_1 n_e n_e_n n_vdd n_gnd tgate Wn=tgate_lut_L5_nmos Wp=tgate_lut_L5_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L5 n_9_1 n_9_2 wire Rw='wire_lut_L5_res/2' Cw='wire_lut_L5_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L5h n_gnd n_9_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L5_nmos Wp=tgate_lut_L5_pmos\n"
    )
    spice_file.write(
        "Xtgate_lut_L6 n_9_2 n_10_1 n_f n_f_n n_vdd n_gnd tgate Wn=tgate_lut_L6_nmos Wp=tgate_lut_L6_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L6 n_10_1 n_10_2 wire Rw='wire_lut_L6_res/2' Cw='wire_lut_L6_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L6h n_gnd n_10_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L6_nmos Wp=tgate_lut_L6_pmos\n\n"
    )
...
def generate_tgate_lut5(spice_filename, min_tran_width, use_finfet):
    ...
    spice_file.write("* First chain\n")
    spice_file.write(
        "Xtgate_lut_L1 n_2_2 n_3_1 n_a n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L1_nmos Wp=tgate_lut_L1_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L1 n_3_1 n_3_2 wire Rw='wire_lut_L1_res/2' Cw='wire_lut_L1_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L2 n_3_2 n_4_1 n_b n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L2_nmos Wp=tgate_lut_L2_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L2 n_4_1 n_4_2 wire Rw='wire_lut_L2_res/2' Cw='wire_lut_L2_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L3 n_4_2 n_5_1 n_c n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L3 n_5_1 n_5_2 wire Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n"
    )
    ...
    spice_file.write("* Second chain\n")
    spice_file.write(
        "Xtgate_lut_L4 n_7_2 n_8_1 n_d n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L4_nmos Wp=tgate_lut_L4_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L4 n_8_1 n_8_2 wire Rw='wire_lut_L4_res/2' Cw='wire_lut_L4_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L5 n_8_2 n_9_1 n_e n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L5_nmos Wp=tgate_lut_L5_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L5 n_9_1 n_9_2 wire Rw='wire_lut_L5_res/2' Cw='wire_lut_L5_cap/2'\n"
    )
...
def generate_tgate_lut4(spice_filename, min_tran_width, use_finfet):
    ...
    spice_file.write("* Second chain\n")
    spice_file.write(
        "Xtgate_lut_L3 n_6_2 n_7_1 n_c n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_pmos\n"
    )
    spice_file.write(
        "Xwire_lut_L3 n_7_1 n_7_2 wire Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n"
    )
    ...
    spice_file.write(
        "Xtgate_lut_L3h n_gnd n_7_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_pmos\n"
    )
    spice_file.write(
        "Xtgate_lut_L4 n_7_2 n_8_1 n_d n_gnd n_vdd n_gnd tgate Wn=tgate_lut_L4_nmos Wp=tgate_lut_L4_pmos\n"
    )
    ...
    if lut_input_type != "default":
        ...
        if lut_input_type == "default_rsel":
            ...
            spice_file.write(
                "Xtgate_"
                + lut_input_name
                + "_0 n_1_2 n_2_1 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_"
                + lut_input_name
                + "_0_nmos Wp=tgate_"
                + lut_input_name
                + "_0_pmos\n"
            ...
            spice_file.write(
                "Xtgate_"
                + lut_input_name
                + "_0h n_gnd n_2_3 n_gate_n n_gate n_vdd n_gnd tgate Wn=tgate_"
                + lut_input_name
                + "_0_nmos Wp=tgate_"
                + lut_input_name
                + "_0_pmos\n"
    ...
    for tgate in range(num_tgate_load):
        ...
        if use_fluts and num_ptran_load == 1:
            spice_file.write(
                ...
                + "_driver_load_"
                + str(tgate)
                + " n_gnd n_vdd n_gnd n_"
                + str(tgate + 1)
                + " n_vdd n_gnd tgate Wn=tgate_flut_mux_nmos Wp=tgate_flut_mux_pmos\n"
            )
        else:
            spice_file.write(
                "Xtgate_lut_"
                ...
                + " n_gnd n_vdd n_gnd n_"
                + str(tgate + 1)
                + " n_vdd n_gnd tgate Wn=tgate_lut_"
                + tgate_level
                + "_nmos Wp=tgate_lut_"
                + tgate_level
                + "_pmos\n"
...
def generate_full_adder(spice_filename, circuit_name, use_finfet):
    ...
    spice_file.write(
        ".SUBCKT FA_"
        + circuit_name
        + " n_a n_b n_cin n_cout n_sum_out n_p n_vdd n_gnd\n"
    )
    ...
    spice_file.write(
        "Xinv_"
        + circuit_name
        + "_1 n_a_in n_a_in_bar n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_1_nmos Wp=inv_"
        + circuit_name
        + "_1_pmos\n"
    ...
    spice_file.write(
        "Xinv_"
        + circuit_name
        + "_2 n_cin_in n_cin_in_bar n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_2_nmos Wp=inv_"
        + circuit_name
        + "_2_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_1 n_cin_in n_sum_internal n_p n_p_bar n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_1_nmos Wp=tgate_"
        + circuit_name
        + "_1_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_2 n_cin_in_bar n_sum_internal n_p_bar n_p n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_2_nmos Wp=tgate_"
        + circuit_name
        + "_2_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_3 n_b_in n_p n_a_in_bar n_a_in n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_3_nmos Wp=tgate_"
        + circuit_name
        + "_3_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_4 n_b_in n_p_bar n_a_in n_a_in_bar n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_4_nmos Wp=tgate_"
        + circuit_name
        + "_4_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_5 n_a_in_bar n_sum_internal n_p_bar n_p n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_5_nmos Wp=tgate_"
        + circuit_name
        + "_5_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_6 n_cin_in_bar n_sum_internal n_p n_p_bar n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_6_nmos Wp=tgate_"
        + circuit_name
        + "_6_pmos\n"
    ...
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_1 n_p n_b_in n_a_in_bar n_gnd ptran Wn=ptran_"
        + circuit_name
        + "_1_nmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_2 n_p_bar n_b_in n_a_in n_gnd ptran Wn=ptran_"
        + circuit_name
        + "_2_nmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_3 n_p_bar n_b_in n_a_in_bar n_vdd ptranp Wn=ptran_"
        + circuit_name
        + "_3_nmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_4 n_p n_b_in n_a_in n_vdd ptranp Wn=ptran_"
        + circuit_name
        + "_4_nmos\n"
    )
    ...
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_1 n_a n_a_in wire Rw='wire_fa_a_res' Cw='wire_fa_a_cap' \n"
    )
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_2 n_b n_b_in wire Rw='wire_fa_b_res' Cw='wire_fa_b_cap' \n"
    )
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_3 n_cin n_cin_in wire Rw='wire_fa_cin_res' Cw='wire_fa_cin_cap' \n"
    )
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_4 n_cout n_cout_in wire Rw='wire_fa_cout_res' Cw='wire_fa_cout_cap' \n"
    )
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_5 n_sum_out n_sum_in wire Rw='wire_fa_cout_res' Cw='wire_fa_cout_cap' \n"
    )

    spice_file.write(
        "Xinv_"
        + circuit_name
        + "_3 n_sum_internal n_sum_in n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_3_nmos Wp=inv_"
        + circuit_name
        + "_3_pmos\n"
...
def generate_full_adder_simplified(spice_filename, circuit_name, use_finfet):
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_5 n_a_in_bar n_cout_in n_p_bar n_p n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_2_nmos Wp=tgate_"
        + circuit_name
        + "_2_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + circuit_name
        + "_6 n_cin_in_bar n_cout_in n_p n_p_bar n_vdd n_gnd tgate Wn=tgate_"
        + circuit_name
        + "_2_nmos Wp=tgate_"
        + circuit_name
        + "_2_pmos\n"
    ...
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_1 n_p n_a_in_bar n_b_in n_gnd ptran Wn=tgate_"
        + circuit_name
        + "_1_nmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_2 n_p_bar n_a_in n_b_in n_gnd ptran Wn=tgate_"
        + circuit_name
        + "_1_nmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_3 n_p_bar n_a_in_bar n_b_in n_vdd ptranp Wn=tgate_"
        + circuit_name
        + "_1_pmos\n"
    )
    spice_file.write(
        "Xptran_"
        + circuit_name
        + "_4 n_p n_a_in n_b_in n_vdd ptranp Wn=tgate_"
        + circuit_name
        + "_1_pmos\n"
    )
    ...
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_3 n_cin n_cin_in wire Rw='wire_"
        + circuit_name
        + "_3_res' Cw='wire_"
        + circuit_name
        + "_3_cap' \n"
    ...
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_4 n_cout n_cout_in wire Rw='wire_"
        + circuit_name
        + "_4_res' Cw='wire_"
        + circuit_name
        + "_4_cap' \n"
    ...
    spice_file.write(
        "Xwire_"
        + circuit_name
        + "_5 n_sum_out n_sum_in wire Rw='wire_"
        + circuit_name
        + "_5_res' Cw='wire_"
        + circuit_name
        + "_5_cap' \n"
...
def generate_carry_chain_perf_ripple(spice_filename, circuit_name, use_finfet):
    ...
    spice_file.write(
        "Xinv_lut_int_buffer_1 n_in n_out n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_1_nmos Wp=inv_"
        + circuit_name
        + "_1_pmos\n"
...
def generate_skip_and_tree(
    spice_filename, circuit_name, use_finfet, nand1_size, nand2_size
):
    ...
    spice_file.write(
        "Xnand1 n_1_1 n_1_2 n_vdd n_gnd nand"
        + str(nand1_size)
        + " Wn=inv_nand"
        + str(nand1_size)
        + "_"
    ...
    spice_file.write(
        "Xinv1 n_1_2 n_1_3 n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_2_nmos Wp=inv_"
        + circuit_name
        + "_2_pmos\n"
    ...
    spice_file.write(
        "Xnand2 n_1_4 n_1_5 n_vdd n_gnd nand"
        + str(nand2_size)
        + " Wn=inv_nand"
        + str(nand2_size)
        + "_"
    ...
    spice_file.write(
        "Xinv2 n_1_5 n_out n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_4_nmos Wp=inv_"
        + circuit_name
        + "_4_pmos\n"
    ...
    tran_names_list = []
    tran_names_list.append(
        "inv_nand" + str(nand1_size) + "_" + circuit_name + "_1_nmos"
    )
    tran_names_list.append(
        "inv_nand" + str(nand1_size) + "_" + circuit_name + "_1_pmos"
    )
    tran_names_list.append("inv_" + circuit_name + "_2_nmos")
    tran_names_list.append("inv_" + circuit_name + "_2_pmos")
    tran_names_list.append(
        "inv_nand" + str(nand2_size) + "_" + circuit_name + "_3_nmos"
    )
    tran_names_list.append(
        "inv_nand" + str(nand2_size) + "_" + circuit_name + "_3_pmos"
    )
...
def generate_carry_inter(spice_filename, circuit_name, use_finfet):
    ...
    spice_file.write(
        "Xinv1 n_in n_1_1 n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_1_nmos Wp=inv_"
        + circuit_name
        + "_1_pmos\n"
    ...
    spice_file.write(
        "Xinv2 n_1_1 n_1_2 n_vdd n_gnd inv Wn=inv_"
        + circuit_name
        + "_2_nmos Wp=inv_"
        + circuit_name
        + "_2_pmos\n"
