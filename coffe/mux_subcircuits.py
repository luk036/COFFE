def _generate_ptran_driver(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(
        "* " + mux_name +
        " driver subcircuit (" + str(implemented_mux_size) + ":1)\n"
    )
    spice_file.write(
        "******************************************************************************************\n"
    )
    spice_file.write(".SUBCKT " + mux_name +
                     "_driver n_in n_out n_vdd n_gnd\n")
    spice_file.write(
        "Xrest_"
        + mux_name
        + " n_in n_1_1 n_vdd n_gnd rest Wp=rest_"
        + mux_name
        + "_pmos\n"
    )
    spice_file.write(
    ...
    spice_file.write(
        "Xwire_"
        + mux_name
        + "_driver n_1_1 n_1_2 wire Rw=wire_"
        + mux_name
        + "_driver_res Cw=wire_"
        + mux_name
        + "_driver_cap\n"
    )
    spice_file.write(
...
def _generate_ptran_sense_only(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(
        "* "
        + mux_name
        + " sense inverter subcircuit ("
        + str(implemented_mux_size)
        + ":1)\n"
    )
    spice_file.write(
        "******************************************************************************************\n"
    ...
    spice_file.write(
        "Xrest_"
        + mux_name
        + " n_in n_out n_vdd n_gnd rest Wp=rest_"
        + mux_name
        + "_pmos\n"
    )
    spice_file.write(
        "Xinv_"
        + mux_name
        + "_1 n_in n_out n_vdd n_gnd inv Wn=inv_"
        + mux_name
        + "_1_nmos Wp=inv_"
        + mux_name
        + "_1_pmos\n"
...
def _generate_ptran_2lvl_mux_off(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(".SUBCKT " + mux_name +
                     "_off n_in n_gate n_gate_n n_vdd n_gnd\n")
    spice_file.write(
        "Xptran_"
        + mux_name
        + "_L1 n_in n_gnd n_gnd n_gnd ptran Wn=ptran_"
        + mux_name
        + "_L1_nmos\n"
    )
    spice_file.write(".ENDS\n\n\n")
...
def _generate_ptran_2lvl_mux_partial(
    spice_file, mux_name, implemented_mux_size, level1_size
):
    ...
    spice_file.write(
        ...
        + " subcircuit ("
        + str(implemented_mux_size)
        + ":1), partially turned on\n"
    )
    spice_file.write(
        "******************************************************************************************\n"
    )
    spice_file.write(
        ".SUBCKT " + mux_name + "_partial n_in n_gate n_gate_n n_vdd n_gnd\n"
    )
    # Write level 1 netlist
    spice_file.write(
        "Xptran_"
        + mux_name
        + "_L1 n_in n_1 n_gate n_gnd ptran Wn=ptran_"
        + mux_name
        + "_L1_nmos\n"
    )
    current_node = "n_1"
    ...
    spice_file.write(
        ...
        + "_L2 "
        + current_node
        + " n_gnd n_gnd n_gnd ptran Wn=ptran_"
        + mux_name
        + "_L2_nmos\n"
    )
    spice_file.write(".ENDS\n\n\n")
...
def _generate_ptran_2lvl_mux_on(
    spice_file, mux_name, implemented_mux_size, level1_size, level2_size
):
    ...
    spice_file.write(
        ...
        + " subcircuit ("
        + str(implemented_mux_size)
        + ":1), fully turned on (mux only)\n"
    )
    spice_file.write(
        "******************************************************************************************\n"
    )
    spice_file.write(
        ".SUBCKT " + mux_name + "_on_mux_only n_in n_out n_gate n_gate_n n_vdd n_gnd\n"
    )
    # Write level 1 netlist
    spice_file.write(
        "Xptran_"
    ...
    spice_file.write(
        ...
        + "_L2 "
        + current_node
        + " n_2 n_gate n_gnd ptran Wn=ptran_"
        + mux_name
        + "_L2_nmos\n"
    )
    current_node = "n_2"
    ...
    if level2_size % 2 == 0:
        ...
        spice_file.write(
            ...
            + "_L2_"
            + str(tran_counter)
            + "h n_gnd n_out n_gnd n_gnd ptran Wn=ptran_"
            + mux_name
            + "_L2_nmos\n"
        )
        wire_counter = wire_counter + 1
...
def generate_ptran_2lvl_mux(
    spice_filename, mux_name, implemented_mux_size, level1_size, level2_size
):
    """
    ...
    _generate_ptran_2lvl_mux_partial(
        spice_file, mux_name, implemented_mux_size, level1_size
    )
    _generate_ptran_2lvl_mux_on(
        spice_file, mux_name, implemented_mux_size, level1_size, level2_size
    )
    ...
    spice_file.write(
        ".SUBCKT " + mux_name + "_on n_in n_out n_gate n_gate_n n_vdd n_gnd\n"
    )
    spice_file.write(
        "X"
        + mux_name
        + "_on_mux_only n_in n_1_1 n_gate n_gate_n n_vdd n_gnd "
        + mux_name
        + "_on_mux_only\n"
    )
    spice_file.write(
        "X" + mux_name + "_driver n_1_1 n_out n_vdd n_gnd " + mux_name + "_driver\n"
    )
    spice_file.write(".ENDS\n\n\n")
...
def generate_ptran_2lvl_mux_no_driver(
    spice_filename, mux_name, implemented_mux_size, level1_size, level2_size
):
    """
    ...
    spice_file.write(
        "X" + mux_name + "_sense n_1_1 n_out n_vdd n_gnd " + mux_name + "_sense\n"
    )
    spice_file.write(".ENDS\n\n\n")
...
def generate_ptran_2_to_1_mux(spice_filename, mux_name):
    ...
    spice_file.write(
        ".SUBCKT " + mux_name + " n_in n_out n_gate n_gate_n n_vdd n_gnd\n"
    )
    spice_file.write(
        "Xptran_"
        + mux_name
        + " n_in n_1_1 n_gate n_gnd ptran Wn=ptran_"
        + mux_name
        + "_nmos\n"
    )
    spice_file.write(
    ...
    spice_file.write(
        "Xptran_"
        + mux_name
        + "_h n_gnd n_1_3 n_gnd n_gnd ptran Wn=ptran_"
        + mux_name
        + "_nmos\n"
    )
    spice_file.write(
        "Xrest_"
        + mux_name
        + " n_1_2 n_2_1 n_vdd n_gnd rest Wp=rest_"
        + mux_name
        + "_pmos\n"
    )
    spice_file.write(
        "Xinv_"
        + mux_name
        + "_1 n_1_2 n_2_1 n_vdd n_gnd inv Wn=inv_"
        + mux_name
        + "_1_nmos Wp=inv_"
        + mux_name
        + "_1_pmos\n"
    ...
    spice_file.write(
        "Xwire_"
        + mux_name
        + "_driver n_2_1 n_2_2 wire Rw=wire_"
        + mux_name
        + "_driver_res Cw=wire_"
        + mux_name
        + "_driver_cap\n"
    ...
    spice_file.write(
        "Xinv_"
        + mux_name
        + "_2 n_2_2 n_out n_vdd n_gnd inv Wn=inv_"
        + mux_name
        + "_2_nmos Wp=inv_"
        + mux_name
        + "_2_pmos\n"
...
def _generate_tgate_2lvl_mux_off(spice_file, mux_name, implemented_mux_size):
    ...
    spice_file.write(
        "Xtgate_"
        + mux_name
        + "_L1 n_in n_gnd n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_L1_nmos Wp=tgate_"
        + mux_name
        + "_L1_pmos\n"
...
def _generate_tgate_2lvl_mux_partial(
    spice_file, mux_name, implemented_mux_size, level1_size
):
    """Generate partially on pass-transistor 2-level mux"""
    ...
    spice_file.write(
        "Xtgate_"
        + mux_name
        + "_L1 n_in n_1 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_L1_nmos Wp=tgate_"
        + mux_name
        + "_L1_pmos\n"
    ...
    for i in range(1, level1_size):
        ...
        spice_file.write(
            ...
            + "h n_gnd "
            + new_node
            + " n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_"
            + mux_name
            + "_L1_nmos Wp=tgate_"
            + mux_name
            + "_L1_pmos\n"
    ...
    spice_file.write(
        ...
        + "_L2 "
        + current_node
        + " n_gnd n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_L2_nmos Wp=tgate_"
        + mux_name
        + "_L2_pmos\n"
...
def _generate_tgate_2lvl_mux_on(
    spice_file, mux_name, implemented_mux_size, level1_size, level2_size
):
    """Generate on pass-transistor 2-level mux, never call this outside this file"""
    ...
    spice_file.write(
        ...
        + "_L2 "
        + current_node
        + " n_2 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_L2_nmos Wp=tgate_"
        + mux_name
        + "_L2_pmos\n"
    ...
    if level2_size % 2 == 0:
        ...
        spice_file.write(
            ...
            + "_L2_"
            + str(tran_counter)
            + "h n_gnd n_out n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_"
            + mux_name
            + "_L2_nmos Wp=tgate_"
            + mux_name
            + "_L2_pmos\n"
...
def generate_tgate_2lvl_mux(
    ...
    _generate_tgate_2lvl_mux_partial(
        spice_file, mux_name, implemented_mux_size, level1_size
    )
    _generate_tgate_2lvl_mux_on(
        spice_file, mux_name, implemented_mux_size, level1_size, level2_size
    )
...
def generate_tgate_2lvl_mux_no_driver(
    spice_filename, mux_name, implemented_mux_size, level1_size, level2_size
):
    """
    Creates two-level MUX files
...
def generate_tgate_2_to_1_mux(spice_filename, mux_name):
    ...
    spice_file.write(
        "Xtgate_"
        + mux_name
        + " n_in n_1_1 n_gate n_gate_n n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_nmos Wp=tgate_"
        + mux_name
        + "_pmos\n"
    ...
    spice_file.write(
        "Xtgate_"
        + mux_name
        + "_h n_gnd n_1_3 n_gnd n_vdd n_vdd n_gnd tgate Wn=tgate_"
        + mux_name
        + "_nmos Wp=tgate_"
        + mux_name
        + "_pmos\n"
